...
export default function Page({ searchParams }: any) {
  ...
  const page: any = (() => {
    ...
    return {
      title: typeof k.title === 'string' ? k.title : String(t('vishnu_stotrasmantras.title', locale) || 'Vishnu Stotras'),
      items: Array.isArray(k.items) ? k.items : parseList(t('vishnu_stotrasmantras.vishnu_stotras', locale))
    };
  })();
