...
export default function GaneshClient() {
  ...
  return (
    <PageLayout metaKey="stotrasmantras_ganesh"
      title={ganesh.title} breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: ganesh.title }]}
      className="layout-md">
      <div className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-yellow-50 via-amber-50 to-yellow-50 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl md:text-lg leading-relaxed">{ganesh?.intro}</p>
        </div>
      </div>
