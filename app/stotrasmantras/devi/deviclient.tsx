...
export default function DeviClient() {
  ...
  return (
    <PageLayout metaKey="stotrasmantras_devi"
      title={devi.title} breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: devi.title }]}
      className="layout-md">
      <div className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-yellow-50 via-amber-50 to-yellow-50 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-md leading-relaxed mb-6">{devi?.intro}</p>
        </div>
      </div>
        ...
        return (
          <div
            ...
            <div className="relative z-10 space-y-4">
              ...
              {section?.description && (
                <p className="text-md md:text-md md:text-md leading-relaxed ">
                  {section.description}
                </p>
              )}
