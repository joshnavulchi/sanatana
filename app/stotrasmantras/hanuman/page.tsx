...
export const generateMetadata = createcreateGenerateMetadata('stotrasmantras_hanuman');
...
export default function Page({ searchParams }: any) {
  ...
  const title = t('hanumanstotras.title', locale) || 'Hanuman Stotras';

  const items = t('hanumanstotras.hanuman_stotras', locale) || [];
