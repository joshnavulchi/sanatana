    ...
    <>
      <main className="min-h-screen px-4 py-6 md:px-8">
        <section className="mx-auto max-w-6xl rounded-3xl bg-[#fffaf0] p-4 shadow-[0_10px_40px_rgba(122,46,31,0.10)] md:p-8">
          ...
          <p className="mt-3 text-lg sm:text-base text-[#6b5d4f]">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl bg-[#fffaf2] p-4">
              <h5 className="text-lg sm:text-base font-semibold text-[#7a2e1f]">Robots</h5>
              <p className="mt-2 text-lg sm:text-base text-[#5b2d12]">Exists: {report.robotsTxt.exists ? 'Yes' : 'No'}</p>
              <p className="text-lg sm:text-base text-[#5b2d12]">
                Sitemap directive: {report.robotsTxt.hasSitemapDirective ? 'Yes' : 'No'}
              </p>
            </article>
            <article className="rounded-2xl bg-[#fffaf2] p-4">
              <h6 className="text-lg sm:text-base font-semibold text-[#7a2e1f]">Sitemap</h6>
              <p className="mt-2 text-lg sm:text-base text-[#5b2d12]">Exists: {report.sitemap.exists ? 'Yes' : 'No'}</p>
              <p className="text-lg sm:text-base text-[#5b2d12]">Approx URL count: {report.sitemap.urlCountApprox}</p>
            </article>
            <article className="rounded-2xl bg-[#fffaf2] p-4">
              <h6 className="text-lg sm:text-base font-semibold text-[#7a2e1f]">Potential issues</h6>
              <p className="mt-2 text-lg sm:text-base text-[#5b2d12]">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <label htmlFor="sortBy" className="text-lg sm:text-base text-[#6b5d4f] font-medium">Sort by:</label>
