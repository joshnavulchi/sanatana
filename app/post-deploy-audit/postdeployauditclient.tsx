      ...
      <main className="min-h-screen bg-linear-to-b from-[#fffaf3] via-[#fdf0d7] to-[#fff8ef] px-4 py-6 md:px-8">
        <section className="mx-auto max-w-6xl rounded-3xl border border-[#d8a25a] bg-[#fffaf0] p-4 shadow-[0_10px_40px_rgba(122,46,31,0.10)] md:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <h4 className="bg-linear-to-r from-[#a63d17] via-[#d97706] to-[#f59e0b] bg-clip-text text-2xl font-semibold text-transparent md:text-3xl">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-[#d8a25a] bg-[#fffaf2] p-4">
              <h5 className="text-sm font-semibold text-[#7a2e1f]">Robots</h5>
            ...
            <article className="rounded-2xl border border-[#d8a25a] bg-[#fffaf2] p-4">
              <h6 className="text-sm font-semibold text-[#7a2e1f]">Sitemap</h6>
            ...
            <article className="rounded-2xl border border-[#d8a25a] bg-[#fffaf2] p-4">
              <h6 className="text-sm font-semibold text-[#7a2e1f]">Potential issues</h6>
