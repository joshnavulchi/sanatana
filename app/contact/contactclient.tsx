          ...
          <div>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-base md:text-md">support@sanatanadharmam.in</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/10">
                ...
                <span className="text-base md:text-md">@SanatanaDharmaMin</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/10">
                ...
                <span className="text-base md:text-md">www.sanatanadharmam.in</span>
              </div>
            </div>
          </div>
          {/* Social links */}
