...
function RenderNode({ node, nodeKey, showHeading }: { node: any; nodeKey?: string; showHeading?: boolean }) {
  ...
  if (Array.isArray(node)) {
    ...
    return (
      <ul className="list-disc pl-5 text-md sm:text-base leading-relaxed">
        {items}
      </ul>
    );
  }
  if (typeof node === 'object') {
    ...
    return (
      <div>
        {heading ? <div className="text-md sm:text-base leading-relaxed font-normal">{heading}</div> : null}
        {Object.keys(node).map(k => {
          ...
          return (
            <div key={k} className="classes text-md sm:text-base leading-relaxed font-normal">
...
export default function ContactPage({ initialTitle = '' }: { initialTitle?: string }) {
  ...
  return (
    <PageLayout metaKey="contact" title={page.title} breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: page.title || 'Contact' }]} className="layout-md">
      <div className="flex flex-col md:flex-row gap-4 md:gap-0 bg-white/80 rounded-3xl shadow-2xl overflow-hidden border-2 border-amber-100 text-md sm:text-base leading-relaxed font-normal">
        {/* Left info panel */}
        <div className="relative md:w-2/5 flex flex-col justify-between bg-gradient-to-br from-amber-500 via-orange-400 to-amber-600 text-white p-6 md:p-10 gap-4 text-md sm:text-base leading-relaxed font-normal">
          <div>
            <div className="flex items-center gap-4 text-md sm:text-base leading-relaxed font-normal">
              <span className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-white/20 backdrop-blur-md shadow-lg text-md sm:text-base leading-relaxed font-normal">
              ...
              <div>
                ...
                {page.subtitle && <p className="text-white/90 text-md sm:text-base leading-relaxed mb-4 font-normal">{page.subtitle}</p>}
              </div>
            </div>
            <div className="space-y-4 text-md sm:text-base leading-relaxed font-normal mt-6">
              ...
              <div className="flex items-center gap-3 text-md sm:text-base leading-relaxed font-normal">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/10 text-md sm:text-base leading-relaxed font-normal">
                ...
                <span className="text-md sm:text-base leading-relaxed font-normal">support@sanatanadharmam.in</span>
              </div>
              <div className="flex items-center gap-3 text-md sm:text-base leading-relaxed font-normal">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/10 text-md sm:text-base leading-relaxed font-normal">
                ...
                <span className="text-md sm:text-base leading-relaxed font-normal">@SanatanaDharmaMin</span>
              </div>
              <div className="flex items-center gap-3 text-md sm:text-base leading-relaxed font-normal">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/10 text-md sm:text-base leading-relaxed font-normal">
                ...
                <span className="text-md sm:text-base leading-relaxed font-normal">www.sanatanadharmam.in</span>
              </div>
            </div>
          </div>
          {/* Social links */}
          <div className="flex gap-4 text-md sm:text-base leading-relaxed font-normal">
        ...
        <div className="md:w-3/5 flex flex-col justify-center bg-white text-md sm:text-base leading-relaxed font-normal">
          <ContactForm />
        </div>
      </div>
      {/* FAQ Section */}
