          ...
          <div>
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                {page.subtitle && <p className="text-white/90 text-md md:text-lg mt-1">{page.subtitle}</p>}
              </div>
            </div>
            <div className="space-y-4 mt-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-md md:text-lg">support@sanatanadharmam.in</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/10">
                ...
                <span className="text-md md:text-lg">@SanatanaDharmaMin</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/10">
                ...
                <span className="text-md md:text-lg">www.sanatanadharmam.in</span>
              </div>
            </div>
          </div>
          {/* Social links */}
