...
export default function PuranasClient() {
  ...
  if (isLoading && !section) {
    return <PageLayout metaKey="puranas" title="" breadcrumbs={[{
      label: 'Home',
      href: '/'
    }, {
      label: 'Puranas'
  ...
  return <PageLayout metaKey="puranas" title={title} breadcrumbs={[{
    label: 'Home',
    href: '/'
  }, {
    label: title
    ...
    {introduction && <div className="relative px-4 md:px-6 py-4 md:py-10 bg-[#fffaf0] rounded-2xl border border-[#d8a25a]/30 overflow-hidden mb-8 shadow-[0_8px_30px_rgba(146,64,14,0.06)]">
      <h2 className="text-2xl font-extrabold text-[#3d2e22] mb-4">{puranas_page.introduc}</h2>
    ...
    {scriptureSections.length > 0 && <div className="mt-8">
      <h2 className="text-2xl font-extrabold text-[#3d2e22] mb-6">{puranas_page.overview}</h2>
    ...
    {philosophical && <div className="mt-10 relative overflow-hidden rounded-3xl border border-[#d8a25a]/30 p-4 md:p-8 bg-linear-to-br from-[#fffaf3] via-[#fdf1dc] to-[#f8e4c0] shadow-[0_8px_30px_rgba(146,64,14,0.06)]">
      <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-[#7c2d12] via-[#d97706] to-[#f59e0b]" />
      <h2 className="text-2xl font-extrabold text-[#3d2e22] mb-4">{puranas_page.philosop_explanat}</h2>
      <div className="text-base md:text-lg text-[#5b2d12] leading-relaxed">
