...
export default function PrivacyPolicy() {
  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: 'Privacy policy' }]}
      className="layout-md bg-gradient-to-br from-[#f7e8ff] via-[#e0c3fc] to-[#8ec5fc] min-h-screen animate-fade-in">
      <div id="privacy-content" className="space-y-10 text-base sm:text-lg leading-relaxed font-normal">
        {/* Header */}
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-white/80 shadow-2xl border border-[#e0c3fc]/40 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.howweuse?.lead}</p>
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-gradient-to-br from-[#f7e8ff]/80 via-[#e0c3fc]/80 to-[#8ec5fc]/80 shadow-xl border border-[#e0c3fc]/30 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.cookieslocalstorage.text}</p>
        </section>
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-white/80 shadow-2xl border border-[#e0c3fc]/40 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.thirdparty.text}</p>
        </section>
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-gradient-to-br from-[#e0c3fc]/80 via-[#f7e8ff]/80 to-[#8ec5fc]/80 shadow-xl border border-[#e0c3fc]/30 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.security.text}</p>
        </section>
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-white/80 shadow-2xl border border-[#e0c3fc]/40 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.rights.lead}</p>
          <ul className="space-y-3 list-disc pl-5 text-base sm:text-lg leading-relaxed">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.rights.contacttext}</p>
        </section>
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-gradient-to-br from-[#f7e8ff]/80 via-[#e0c3fc]/80 to-[#8ec5fc]/80 shadow-xl border border-[#e0c3fc]/30 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.children.text}</p>
        </section>
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-white/80 shadow-2xl border border-[#e0c3fc]/40 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.changes.text}</p>
        </section>
        ...
        <section className="rounded-3xl p-6 md:p-12 bg-gradient-to-br from-[#e0c3fc]/80 via-[#f7e8ff]/80 to-[#8ec5fc]/80 shadow-xl border border-[#e0c3fc]/30 backdrop-blur-md transition-all duration-500 hover:scale-[1.01]">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.contact.lead}</p>
          ...
          <p className="pt-4 text-base sm:text-lg leading-relaxed mb-4 font-medium text-[#4b3869]">{privacy.contact.closing}</p>
        </section>
      </div>
    </PageLayout>
  );
