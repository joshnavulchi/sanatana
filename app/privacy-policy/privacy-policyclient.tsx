      ...
      <div id="privacy-content" className="space-y-8">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4 pb-6 border-b-2 border-amber-200">
          <div className="flex items-center gap-3">
            ...
            <strong className="text-md md:text-lg ">{privacy.lastupdated}</strong>
          </div>
        ...
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h3 className="text-base md:text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">📊</span>
        ...
        {/* How We Use */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h4 className="text-base md:text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">🎯</span>
        ...
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h5 className="text-base md:text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">🍪</span>
        ...
        {/* Third Party */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h6 className="text-base md:text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">🔗</span>
        ...
        {/* Security */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <p className="text-base md:text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">🔐</span>
