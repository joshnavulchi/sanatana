  ...
  return (
    ...
    >
      <div className="space-y-8 md:space-y-12 text-md sm:text-base leading-relaxed font-normal bg-gradient-to-br from-emerald-50 via-teal-100 to-emerald-100/80 rounded-3xl border border-emerald-200/30 shadow-xl p-8 md:p-12 animate-fadeIn">
        ...
        <p className="body-text text-md sm:text-base leading-relaxed mb-4 font-normal text-emerald-900/90 bg-gradient-to-r from-emerald-50/80 to-teal-100/60 rounded-lg px-3 py-2 shadow-sm">{page.informationDesc}</p>

        <h5 className="section-title text-xl font-semibold leading-snug mb-2 text-emerald-800">{page.howWeUse}</h5>
        <p className="body-text text-md sm:text-base leading-relaxed mb-4 font-normal text-emerald-900/90 bg-gradient-to-r from-teal-50/80 to-emerald-100/60 rounded-lg px-3 py-2 shadow-sm">{page.howWeUseDesc}</p>

        <h6 className="section-title text-xl font-semibold leading-snug mb-2 text-emerald-800">{page.yourRights}</h6>
        <p className="body-text text-md sm:text-base leading-relaxed mb-4 font-normal text-emerald-900/90 bg-gradient-to-r from-emerald-50/80 to-teal-100/60 rounded-lg px-3 py-2 shadow-sm">{page.yourRightsDesc}</p>

        <p className="text-md sm:text-base leading-relaxed mb-4 font-normal text-emerald-700"><strong>{page.lastUpdated}</strong></p>
      </div>
    </PageLayout>
  );
}
