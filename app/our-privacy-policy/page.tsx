...
export default function PrivacyPolicyPage({ searchParams }: any) {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-2xl md:text-3xl text-gray-900 dark:text-amber-100">{page.title}</h2>
        <p className="text-gray-700 dark:text-amber-100">{page.intro}</p>
        <h3 className="text-2xl md:text-3xl text-gray-900 dark:text-amber-100">{page.informationHeading}</h3>
        <p className="text-gray-700 dark:text-amber-100">{page.informationDesc}</p>
        <h3 className="text-2xl md:text-3xl text-gray-900 dark:text-amber-100">{page.howWeUse}</h3>
        <p className="text-gray-700 dark:text-amber-100">{page.howWeUseDesc}</p>
        <h3 className="text-2xl md:text-3xl text-gray-900 dark:text-amber-100">{page.yourRights}</h3>
        <p className="text-gray-700 dark:text-amber-100">{page.yourRightsDesc}</p>
        <p className="mt-6 text-gray-700 dark:text-amber-100"><strong>{page.lastUpdated}</strong></p>
      </div>
    </PageLayout>
  );
}
