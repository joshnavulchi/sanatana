...
export default function PrivacyPolicyPage({ searchParams }: any) {
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div className="space-y-8 md:space-y-12 text-lg sm:text-base leading-relaxed font-normal bg-gradient-to-br from-emerald-50 via-teal-100 to-emerald-100/80 rounded-3xl border border-emerald-200/30 shadow-xl p-8 md:p-12 animate-fadeIn">
