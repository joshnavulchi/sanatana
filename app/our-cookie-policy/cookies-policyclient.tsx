...
export default function PrivacyPolicy() {
  ...
  if (isLoading && !privacy.title) {
    return (
      <PageLayout metaKey="cookies-policy.meta" title="cookies-policy.title" breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: 'Cookies Policy' }]} className="layout-sm">
  ...
  return (
    ...
    >
      <div id="cookies-content" className="space-y-8">
        ...
        {/* How We Use */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h4 className="text-xl md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🎯</span>
        ...
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h5 className="text-xl md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🍪</span>
        ...
        {/* Third Party */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h6 className="text-xl md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🔗</span>
        ...
        {/* Security */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <p className="text-xl md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🔐</span>
