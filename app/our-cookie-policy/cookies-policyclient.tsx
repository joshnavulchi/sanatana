...
export default function PrivacyPolicy() {
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div id="cookies-content" className="space-y-8 text-lg sm:text-base leading-relaxed font-normal">
        {/* Header */}
        <div className="flex items-center justify-between flex-wrap gap-4 pb-6 text-lg sm:text-base leading-relaxed font-normal">
          <div className="flex items-center gap-3 text-lg sm:text-base leading-relaxed font-normal">
            ...
            <strong className="text-xl md:text-lg sm:text-base">{privacy.lastupdated}</strong>
          </div>
        ...
        <section className="rounded-2xl p-4 md:p-8">
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.intro.text}</p>
        </section>
        ...
        {/* How We Use */}
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          <h4 className="text-lg sm:text-base sm:text-lg sm:text-base font-semibold mb-4 flex items-center gap-3">
            <span className="text-lg sm:text-base leading-relaxed font-normal">🎯</span>
            {privacy.howweuse?.title}
          </h4>
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.howweuse?.lead}</p>
          <ul className="space-y-3 list-disc pl-5 text-lg sm:text-base leading-relaxed">
            {(privacy.howweuse?.items || []).map((p: string, i: number) => (
              <li key={i} className="flex items-start gap-3 mb-2">
                ...
                <span className="flex-1 text-lg sm:text-base leading-relaxed font-normal">{p}</span>
              </li>
            ))}
          </ul>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          <h5 className="text-lg sm:text-base sm:text-lg sm:text-base font-semibold mb-4 flex items-center gap-3">
            <span className="text-lg sm:text-base leading-relaxed font-normal">🍪</span>
            {privacy.cookieslocalstorage.title}
          </h5>
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.cookieslocalstorage.text}</p>
        </section>

        {/* Third Party */}
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          <h6 className="text-lg sm:text-base sm:text-lg sm:text-base font-semibold mb-4 flex items-center gap-3">
            <span className="text-lg sm:text-base leading-relaxed font-normal">🔗</span>
            {privacy.thirdparty.title}
          </h6>
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.thirdparty.text}</p>
        </section>

        {/* Security */}
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          <p className="flex items-center gap-3 text-lg sm:text-base leading-relaxed mb-4 font-normal">
            <span className="text-lg sm:text-base leading-relaxed font-normal">🔐</span>
            {privacy.security.title}
          </p>
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.security.text}</p>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.rights.lead}</p>
          <ul className="space-y-3 list-disc pl-5 text-lg sm:text-base leading-relaxed">
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.rights.contacttext}</p>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.children.text}</p>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.changes.text}</p>
        </section>
        ...
        <section className="rounded-2xl p-4 md:p-8">
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.contact.lead}</p>
          <div className="space-y-2 text-lg sm:text-base leading-relaxed font-normal">
          ...
          <p className="pt-4 text-lg sm:text-base leading-relaxed mb-4 font-normal">{privacy.contact.closing}</p>
        </section>
      </div>
    </PageLayout>
  );
