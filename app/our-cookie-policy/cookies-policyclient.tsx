...
export default function PrivacyPolicy() {
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div id="cookies-content" className="space-y-8">
        {/* Header */}
        ...
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h3 className="text-xl md:text-lg md:text-md md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">📊</span>
        ...
        {/* How We Use */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h4 className="text-xl md:text-lg md:text-md md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🎯</span>
        ...
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h5 className="text-xl md:text-lg md:text-md md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🍪</span>
        ...
        {/* Third Party */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <h6 className="text-xl md:text-lg md:text-md md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🔗</span>
        ...
        {/* Security */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 shadow-lg">
          <p className="text-xl md:text-lg md:text-md md:text-2xl font-bold mb-4 flex items-center gap-3">
            <span className="text-2xl">🔐</span>
