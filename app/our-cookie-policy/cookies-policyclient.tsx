...
export default function PrivacyPolicy() {
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div id="cookies-content" className="space-y-8 text-base sm:text-lg leading-relaxed font-normal">
        {/* Header */}
        <div className="flex items-center justify-between flex-wrap gap-4 pb-6 text-base sm:text-lg leading-relaxed font-normal">
          <div className="flex items-center gap-3 text-base sm:text-lg leading-relaxed font-normal">
            ...
            <strong className="text-xl md:text-base sm:text-lg">{privacy.lastupdated}</strong>
          </div>
        ...
        <section className="rounded-2xl p-4 md:p-8">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.intro.text}</p>
        </section>
        ...
        {/* How We Use */}
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          <h4 className="text-base sm:text-lg sm:text-base sm:text-lg font-semibold mb-4 flex items-center gap-3">
            <span className="text-base sm:text-lg leading-relaxed font-normal">🎯</span>
            {privacy.howweuse?.title}
          </h4>
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.howweuse?.lead}</p>
          <ul className="space-y-3 list-disc pl-5 text-base sm:text-lg leading-relaxed">
            {(privacy.howweuse?.items || []).map((p: string, i: number) => (
              <li key={i} className="flex items-start gap-3 mb-2">
                ...
                <span className="flex-1 text-base sm:text-lg leading-relaxed font-normal">{p}</span>
              </li>
            ))}
          </ul>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          <h5 className="text-base sm:text-lg sm:text-base sm:text-lg font-semibold mb-4 flex items-center gap-3">
            <span className="text-base sm:text-lg leading-relaxed font-normal">🍪</span>
            {privacy.cookieslocalstorage.title}
          </h5>
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.cookieslocalstorage.text}</p>
        </section>

        {/* Third Party */}
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          <h6 className="text-base sm:text-lg sm:text-base sm:text-lg font-semibold mb-4 flex items-center gap-3">
            <span className="text-base sm:text-lg leading-relaxed font-normal">🔗</span>
            {privacy.thirdparty.title}
          </h6>
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.thirdparty.text}</p>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.security.text}</p>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.rights.lead}</p>
          <ul className="space-y-3 list-disc pl-5 text-base sm:text-lg leading-relaxed">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.rights.contacttext}</p>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.children.text}</p>
        </section>
        ...
        <section className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.changes.text}</p>
        </section>
        ...
        <section className="rounded-2xl p-4 md:p-8">
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.contact.lead}</p>
          ...
          <p className="pt-4 text-base sm:text-lg leading-relaxed mb-4 font-normal">{privacy.contact.closing}</p>
        </section>
      </div>
    </PageLayout>
  );
