    ...
    >
      ...
      <div id="temples-india-content">
        ...
        {data.items.map((section: any, index: number) => {
          ...
          return (
            <div key={section.id || index} className="relative bg-white border-2 border-sky-100 rounded-2xl p-6 md:p-8 mt-12 shadow-lg hover:shadow-2xl transition-all duration-500 group overflow-hidden">
              ...
              <div className="relative z-10 space-y-4">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-sky-100 to-indigo-100 rounded-xl flex items-center justify-center text-2xl shadow-md group-hover:scale-105 group-hover:rotate-3 transition-transform duration-300">{icon}</div>
