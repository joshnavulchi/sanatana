...
export default function TemplesInIndiaClient() {
  ...
  return (
    <PageLayout metaKey="temples_in_india"
      ...
      <div id="temples-in-india" className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-sky-50 via-indigo-50 to-sky-50 rounded-2xl overflow-hidden">
      ...
      {data.items.map((section: any, index: number) => {
        ...
        return (
          <div key={section.id || index} className="relative bg-white border-2 border-sky-100 rounded-2xl p-6 md:p-8 mt-12 transform-gpu transition-transform duration-300 hover:-translate-y-1 hover:scale-104 ring-1 ring-sky-100/30 bg-white/85 backdrop-blur-sm group overflow-hidden">
            ...
            <div className="relative z-10 space-y-4">
              ...
              {section?.how_it_was_built && <p className="text-md leading-relaxed ">{section.how_it_was_built}</p>}
      ...
      {data.disclaimer && (
        <div className="relative bg-gradient-to-br from-sky-50 to-indigo-50 border-l-4 border-indigo-400 rounded-lg p-6 md:p-8 mt-12 ring-1 ring-sky-100/30 bg-white/70 backdrop-blur-sm">
          <div className="flex items-start gap-4">
            <span className="text-3xl">⚠️</span>
            <div className="flex-1">
              <h4 className="text-md font-bold text-gray-900 mb-2">Disclaimer</h4>
