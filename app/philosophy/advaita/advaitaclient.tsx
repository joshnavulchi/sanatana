...
export default function AdvaitaClient() {
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div id="advaita-content" className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-indigo-50 via-blue-50 to-indigo-50 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl md:text-lg text-indigo-900 mb-6 italic">{data.definition}</p>
