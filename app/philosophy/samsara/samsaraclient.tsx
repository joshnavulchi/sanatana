...
export default function SamsaraClient() {
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div id="samsara-content" className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-blue-50 via-green-100 to-blue-50 border-l-12 border-blue-200 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl md:text-lg text-blue-900 mb-6 italic">{page.definition}</p>
          <div className="mb-6">
