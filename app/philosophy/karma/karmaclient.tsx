  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-xl p-6 bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-100">
        ...
        <p className="mt-2 text-xl md:text-lg text-amber-700">A concise retelling and practical reflections on karma.</p>
      </div>
      ...
      <div className="grid gap-6">
        {lines.map((line: any, idx: number) => (
          ...
          >
            ...
            <div>
              <p className="text-xl md:text-lg text-gray-800 leading-relaxed ">{line}</p>
            </div>
            <div className="mt-4 flex items-center justify-between text-xl md:text-lg text-gray-500">
  ...
  return (
    <section className="mt-12">
      <div className="flex items-center gap-3 mb-6">
        <span className="text-xl md:text-lg text-amber-700 font-semibold">💬 Dialogue</span>
            ...
            <div key={idx} className={`flex ${isLeft ? 'justify-start' : 'justify-end'}`}>
              <div className={`max-w-[86%] md:max-w-[70%]`}>
                <div className={`flex items-center gap-3 ${isLeft ? '' : 'flex-row-reverse'}`}>
                  ...
                  <div className="text-xl md:text-lg text-gray-600 font-medium">{item.speaker || (isLeft ? 'Seeker' : 'Teacher')}</div>
                </div>
