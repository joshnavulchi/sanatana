...
export default function MokshaClient() {
  ...
  const nsObj = useLocaleSection('philosophy_moksha');
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div id="moksha-content" className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-green-50 via-green-100 to-green-50 border-l-12 border-green-200 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl md:text-lg text-emerald-900 mb-6 italic">{page.definition}</p>
          <div className="mb-6">
