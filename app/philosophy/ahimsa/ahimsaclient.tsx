...
export default function AhimsaClient() {
  ...
  return (
    <PageLayout
      ...
      className="layout-md"
    >
      <div id="ahimsa-content" className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-emerald-50 via-emerald-100 to-emerald-50 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl md:text-lg text-emerald-900 mb-6 italic">
