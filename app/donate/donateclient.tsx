...
export default function DonateClient() {
  ...
  if (isLoading && !donate.title) {
    return (
      <PageLayout metaKey="donate" title="" breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: 'Donate' }]} className="layout-sm">
        <div className="flex items-center justify-center py-6 text-base leading-relaxed font-normal">
          <Loader />
        </div>
      </PageLayout>
    );
  ...
  return (
    <PageLayout
      ...
      className={`layout-sm`}
    >
      <div id="donate-content" className="space-y-12 text-base leading-relaxed font-normal">
        <div className="text-center max-w-3xl mx-auto text-base leading-relaxed font-normal">
          <p className="text-base leading-relaxed mb-4 font-normal">{donate.subtitle}</p>
        </div>

        {/* Purpose */}
        <section className="relative">
          <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-amber-50 rounded-2xl shadow-sm border border-amber-200 p-5 overflow-hidden text-base leading-relaxed font-normal">
            <div className="absolute top-0 right-0 w-48 h-48 bg-amber-100 rounded-full blur-3xl text-base leading-relaxed font-normal" />
            <div className="relative z-10 text-base leading-relaxed font-normal">
              <div className="flex items-center gap-3 text-base leading-relaxed font-normal">
                <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-sm text-base leading-relaxed font-normal">
              ...
              <ul className="space-y-4 list-disc pl-5 text-base leading-relaxed">
                {(donate.purpose?.points || []).map((p: string, i: number) => (
                  <li key={i} className="flex items-start gap-2 group mb-2">
                    <span className="flex-shrink-0 w-8 h-8 bg-amber-500 text-white rounded-full flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-200 text-base leading-relaxed font-normal">
                      {i + 1}
                    </span>
                    <span className="flex-1 pt-1 text-base leading-relaxed font-normal">{p}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <section className="relative">
          <div className="text-center text-base leading-relaxed font-normal">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-amber-400 to-orange-500 mx-auto rounded-full text-base leading-relaxed font-normal"></div>
          </div>
          <div className="overflow-x-auto rounded-2xl shadow-sm border border-amber-200 text-base leading-relaxed font-normal">
        ...
        {/* Donate */}
        <section className="relative">
          <div className="bg-gradient-to-br from-white via-amber-50 to-orange-50 rounded-2xl shadow-sm border border-amber-200 p-5 overflow-hidden text-base leading-relaxed font-normal">
            <div className="absolute inset-0 opacity-40 text-base leading-relaxed font-normal" aria-hidden="true" />
            <div className="relative z-10 text-base leading-relaxed font-normal">
              <div className="text-center text-base leading-relaxed font-normal">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl shadow-sm text-base leading-relaxed font-normal">
                ...
                <p className="text-base leading-relaxed mb-4 font-normal">{donate.donateOptions?.oneTime?.note}</p>
              </div>
              <div className="flex flex-col md:flex-row items-center justify-center gap-8 my-10 text-base leading-relaxed font-normal">
                <div className="group text-base leading-relaxed font-normal">
                  <div className="bg-white rounded-2xl shadow-sm p-5 border border-amber-200 hover:border-amber-300 transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-sm text-base leading-relaxed font-normal">
                    <div className="text-center text-base leading-relaxed font-normal">
                      <span className="inline-block px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-base leading-relaxed font-normal">PayPal</span>
                    </div>
                    <LazyImage
                ...
                <div className="group text-base leading-relaxed font-normal">
                  <div className="bg-white rounded-2xl shadow-sm p-5 border border-amber-200 hover:border-amber-300 transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-sm text-base leading-relaxed font-normal">
                    <div className="text-center text-base leading-relaxed font-normal">
                      <span className="inline-block px-4 py-2 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-full text-base leading-relaxed font-normal">UPI</span>
                    </div>
                    <LazyImage
