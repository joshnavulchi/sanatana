                  ...
                  <ul className="space-y-4 mt-6 pl-0!">
                    {section.keypoints.map((point: any, idx: number) => (
                      <li key={idx} className="bg-orange-50 p-5 rounded-r-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                        ...
                        {point.para1 && <div className="text-gray-700 text-md md:text-md md:text-md pl-4 leading-relaxed mb-2">{point.para1}</div>}
                        {point.para2 && <div className="text-gray-700 text-md md:text-md md:text-md pl-4 leading-relaxed mb-2">{point.para2}</div>}
                        {point.para3 && <div className="text-gray-700 text-md md:text-md md:text-md pl-4 leading-relaxed">{point.para3}</div>}
                      </li>
                    ))}
                  </ul>
                )}
