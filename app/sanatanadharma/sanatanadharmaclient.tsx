          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 space-y-5">
                ...
                {section?.para1 && (
                  <p className="text-md md:text-lg leading-loose text-gray-700 pl-0 first-letter:text-5xl first-letter:font-bold first-letter:text-orange-600 first-letter:mr-1 first-letter:float-left">{section.para1}</p>
                )}
                {section?.para2 && (
                  <p className="text-md md:text-lg leading-loose text-gray-700 pl-0">{section.para2}</p>
                )}
                {section?.para3 && (
                  <p className="text-md md:text-lg leading-loose text-gray-700 pl-0">{section.para3}</p>
                )}
                  ...
                  <ul className="space-y-4 mt-6 pl-0!">
                    {section.keypoints.map((point: any, idx: number) => (
                      <li key={idx} className="bg-orange-50 p-5 rounded-r-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                        <div className="font-bold text-orange-800 mb-2 text-md md:text-lg flex items-center gap-2">
