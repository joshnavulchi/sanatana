          ...
          <div className="relative md:-mx-8 px-6 md:px-8 py-12 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 rounded-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {pageContent.meta?.description && (
                <p className="text-lg md:text-md  leading-relaxed mb-4">
                  {pageContent.meta.description}
                </p>
              )}
              {pageContent.intro && (
                <p className="text-xl md:text-lg md:text-md md:text-md text-gray-600 leading-relaxed">{pageContent.intro}</p>
              )}
              {pageContent.description && (
                <p className="text-xl md:text-lg md:text-md md:text-md text-gray-600 leading-relaxed">{pageContent.description}</p>
              )}
            </div>
          </div>
