        ...
        <div className="space-y-12">
          ...
          <div className="relative md:-mx-8 px-6 md:px-8 py-12 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 rounded-2xl overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              {pageContent.intro && (
                <p className="text-base md:text-md text-gray-600 leading-relaxed">{pageContent.intro}</p>
              )}
              {pageContent.description && (
                <p className="text-base md:text-md text-gray-600 leading-relaxed">{pageContent.description}</p>
              )}
            </div>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-base md:text-md text-gray-600">{pageContent.decades.length} periods of transformation</p>
                  </div>
                </div>
              </div>
                        ...
                        <div className="mb-4">
                          ...
                          <ul className="space-y-2">
                            {d.whatChanged.map((w: string, i: number) => (
                              <li key={i} className="flex items-start gap-2 text-base md:text-md  ">
