      ...
      <div className="space-y-12">
        ...
        <div className="relative md:-mx-8 px-6 md:px-8 py-12 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 dark:from-blue-950/30 dark:via-indigo-950/30 dark:to-blue-950/30 rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {pageContent.meta?.description && <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
        ...
        {pageContent.whyBordersBecameStable && <section className="space-y-6">
            ...
            {pageContent.whyBordersBecameStable.summary && <p className="text-gray-700 dark:text-gray-300 leading-relaxed pl-15">{pageContent.whyBordersBecameStable.summary}</p>}
            ...
            <div className="relative space-y-6">
              ...
              {pageContent.decades.map((d: any, idx: number) => <div key={d.key ?? d.decade ?? d.label ?? idx} className="relative">
                  ...
                  <div className="md:ml-20 bg-white dark:bg-gray-800 border-2 border-blue-100 dark:border-blue-900/30 hover:border-blue-300 dark:hover:border-blue-700 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group">
                    ...
                    {d.summary && <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{d.summary}</p>}
                    ...
                    {d.whatChanged && Array.isArray(d.whatChanged) && d.whatChanged.length > 0 && <div className="mb-4">
                        ...
                        <ul className="space-y-2">
                          {d.whatChanged.map((w: string, i: number) => <li key={i} className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    {d.why && Array.isArray(d.why) && d.why.length > 0 && <div className="mb-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <ul className="space-y-2">
                          {d.why.map((w: string, i: number) => <li key={i} className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
