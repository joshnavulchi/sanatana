    ...
    <div className="space-y-12">
      ...
      <div className="relative md:-mx-8 px-6 md:px-8 py-12 bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-50 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {pageContent.meta?.description && <p className="text-lg md:text-xl   leading-relaxed mb-4">
            {pageContent.meta.description}
          </p>}
          {pageContent.intro && <p className="text-base md:text-lg text-gray-600  leading-relaxed">{pageContent.intro}</p>}
          {pageContent.description && <p className="text-base md:text-lg text-gray-600  leading-relaxed">{pageContent.description}</p>}
        </div>
      </div>
      ...
      {pageContent.whyBordersBecameStable && <section className="space-y-6">
        ...
        {pageContent.whyBordersBecameStable.summary && <p className="  leading-relaxed pl-15">{pageContent.whyBordersBecameStable.summary}</p>}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 ">{pageContent.decades.length} {world_transformation_meta_page.periods_transfor}</p>
            </div>
          </div>
        </div>
            ...
            <div className="md:ml-20 bg-white  border-2 border-blue-100  hover:border-blue-300  rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group">
              ...
              {d.whatChanged && Array.isArray(d.whatChanged) && d.whatChanged.length > 0 && <div className="mb-4">
                ...
                <ul className="space-y-2">
                  {d.whatChanged.map((w: string, i: number) => <li key={i} className="flex items-start gap-2 text-sm  ">
              ...
              {d.why && Array.isArray(d.why) && d.why.length > 0 && <div className="mb-4 pt-4 border-t border-gray-200 ">
                ...
                <ul className="space-y-2">
                  {d.why.map((w: string, i: number) => <li key={i} className="flex items-start gap-2 text-sm  ">
