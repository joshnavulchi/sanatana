    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="space-y-8 text-md leading-relaxed font-normal bg-gradient-to-br from-blue-50 via-blue-100 to-cyan-50 rounded-3xl border border-blue-200/30 shadow-xl p-6 md:p-10 animate-fadeIn"
        >
          {page.sections.map((section: any, idx: number) => (
            ...
            >
              ...
              {section.text && (
                <p className="body-text text-md leading-relaxed mb-4 font-normal text-blue-800/90">{section.text}</p>
              )}
            </section>
          ))}
        </div>
