...
export default function TemplesDestroyedClient() {
  ...
  return (
    ...
    >
      ...
      <div id="temples-destroyed-content">
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-3/4">
            <div className="relative px-3 md:px-6 py-12 md:py-16 bg-gradient-to-br from-slate-50 via-gray-50 to-slate-50 rounded-2xl overflow-hidden">
              ...
              return (
                <div key={section.id || index} className="relative bg-white border-2 border-slate-100 rounded-2xl p-6 md:p-8 mt-12 transform-gpu transition-transform duration-300 hover:-translate-y-1 hover:scale-103 ring-1 ring-slate-100/30 bg-white/85 backdrop-blur-sm group overflow-hidden">
                  ...
                  <div className="relative z-10 space-y-4">
                    ...
                    <p className="text-xl md:text-lg md:text-md md:text-lg md:text-md leading-relaxed ">{section.summary || section.event_type?.join?.(', ') || section.period || section.approx_date}</p>
