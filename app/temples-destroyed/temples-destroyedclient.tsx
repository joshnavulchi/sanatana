...
export default function TemplesDestroyedClient() {
  ...
  if (isLoading && !data.title) {
    return (
      <PageLayout metaKey="temples_destroyed" title="" breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: 'Temples' }]} className="layout-sm">
            ...
            <div key={section.id || index} className="relative bg-white border-2 border-amber-100 rounded-2xl p-6 md:p-8 mt-12 shadow-lg hover:shadow-2xl transition-all duration-500 group overflow-hidden">
              ...
              <div className="relative z-10 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <Tag className="flex-1 text-2xl md:text-3xl font-bold text-gray-900 group-hover:text-amber-600 transition-colors duration-300">{section.temple_name || section.summary || section.id || section.title}</Tag>
                </div>
