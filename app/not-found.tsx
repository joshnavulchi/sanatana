...
export default function NotFoundPage() {
  return (
    <main className="min-h-screen flex items-center justify-center p-4 md:p-6">
      <div className="w-full max-w-4xl rounded-3xl bg-white shadow-md p-4 sm:p-12 text-base leading-relaxed font-normal">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center text-base leading-relaxed font-normal">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 text-base leading-relaxed font-normal">
              ...
              <Link
                href="/contact"
                className="rounded-md px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 text-center"
              >
                Contact support
              </Link>
            </div>
