...
export default function NotFoundPage() {
  return (
    <main className="min-h-screen flex items-center justify-center p-4 md:p-6 bg-gradient-to-br from-rose-100 via-amber-50 to-pink-200 animate-gradient-x">
      <div className="w-full max-w-4xl rounded-3xl bg-white/90 shadow-2xl p-4 sm:p-12 text-base leading-relaxed font-normal border-4 border-amber-100 backdrop-blur-xl animate-fadeInUp">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center text-base leading-relaxed font-normal">
          <div>
            ...
            <p className="text-rose-600 text-base leading-relaxed mb-4 font-normal animate-fadeIn delay-100">This link may be broken or the page may have been removed. Try these options instead.</p>

            <div className="flex flex-col sm:flex-row gap-3 text-base leading-relaxed font-normal">
              <Link
                href="/"
                className="rounded-full bg-gradient-to-r from-amber-500 via-pink-400 to-rose-400 px-6 py-3 text-sm font-semibold text-white shadow-lg hover:from-amber-600 hover:to-rose-500 transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-pink-200 animate-pulse text-center"
              >
                Back to homepage
              </Link>
              ...
              <Link
                href="/contact"
                className="rounded-full px-6 py-3 text-sm font-semibold text-rose-700 bg-white/80 shadow hover:bg-rose-50 transition-all duration-300 text-center border border-rose-200 animate-fadeIn delay-200"
              >
                Contact support
              </Link>
            </div>
          ...
          <div className="flex items-center justify-center text-base leading-relaxed font-normal animate-fadeInUp delay-200">
