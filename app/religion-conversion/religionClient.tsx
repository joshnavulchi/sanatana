    ...
    >
      ...
      {ns?.theological_analysis && (
        <section className="my-12 p-8 rounded-xl shadow-lg bg-gradient-to-br from-indigo-50 to-blue-100 border-l-8 border-indigo-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-xl md:text-lg font-bold text-blue-700 mb-2">Hinduism</h4>
            ...
            <div>
              <h5 className="text-xl md:text-lg font-bold text-rose-700 mb-2">Christianity</h5>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <div>
              <h6 className="text-xl md:text-lg font-bold text-green-700 mb-2">Islam</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      {ns?.textual_historical_development && (
        <section className="my-12 p-8 rounded-xl shadow-lg bg-gradient-to-br from-amber-50 to-yellow-100 border-l-8 border-amber-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h5 className="text-xl md:text-lg font-bold text-blue-700 mb-2">Vedic Tradition</h5>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <h6 className="text-xl md:text-lg font-bold text-blue-700 mt-4 mb-2">Upanishadic Development</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <div>
              <h6 className="text-xl md:text-lg font-bold text-rose-700 mb-2">Christianity</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <h6 className="text-xl md:text-lg font-bold text-green-700 mt-4 mb-2">Abrahamic Traditions</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
              ...
              <h6 className="text-xl md:text-lg font-bold text-green-700 mt-4 mb-2">Islam</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      {ns?.linguistic_evolution && (
        <section className="my-12 p-8 rounded-xl shadow-lg bg-gradient-to-br from-blue-50 to-rose-100 border-l-8 border-blue-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h6 className="text-xl md:text-lg font-bold text-green-700 mb-2">Brahman (Hinduism)</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <div>
              <h6 className="text-xl md:text-lg font-bold text-rose-700 mb-2">God (Christianity)</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <div>
              <h6 className="text-xl md:text-lg font-bold text-blue-700 mb-2">Allah (Islam)</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
      ...
      {ns?.philosophical_differences && (
        <section className="my-12 p-8 rounded-xl shadow-lg bg-gradient-to-br from-rose-50 to-blue-100 border-l-8 border-rose-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h6 className="text-xl md:text-lg font-bold text-blue-700 mb-2">Ontology</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <div>
              <h6 className="text-xl md:text-lg font-bold text-green-700 mb-2">Incarnation</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <div>
              <h6 className="text-xl md:text-lg font-bold text-rose-700 mb-2">Time Concept</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg p-6 mt-12">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h6 className="text-xl md:text-lg font-bold text-yellow-800 mb-2">Disclaimer</h6>
