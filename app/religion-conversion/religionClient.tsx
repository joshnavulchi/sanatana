      ...
      {ns?.theological_analysis && (
        <section className="my-12 p-8 rounded-xl shadow-lg bg-gradient-to-br from-indigo-50 to-blue-100 border-l-8 border-indigo-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h4 className="text-xl font-bold text-blue-700 mb-2">Hinduism</h4>
            ...
            <div>
              <h5 className="text-xl font-bold text-rose-700 mb-2">Christianity</h5>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <div>
              <h6 className="text-xl font-bold text-green-700 mb-2">Islam</h6>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
