...
export default function TermsOfService() {
  ...
  return (
    <PageLayout
      ...
      className="layout-md">
      <div className="space-y-8 text-lg sm:text-base leading-relaxed font-normal" id="terms-of-service-content">
        <div className="flex items-center justify-between flex-wrap gap-4 pb-6 text-lg sm:text-base leading-relaxed font-normal">
          <div className="flex items-center gap-3 text-lg sm:text-base leading-relaxed font-normal">
            ...
            <strong className="text-xl md:text-lg sm:text-base">{page.lastupdated}</strong>
          </div>
        ...
        <section>
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{page.disclaimertext}</p>
          <ul role="list" className="space-y-3 list-disc pl-5 text-lg sm:text-base leading-relaxed">
            {[0, 1, 2, 3].map((i) => {
              const item = renderListItem(page.disclaimerlist, i);
              return item ? (
                <li key={i} className="flex items-start gap-3 mb-2">
                  <span className="shrink-0 w-2 h-2 rounded-full text-lg sm:text-base leading-relaxed font-normal" />
                  <span className="flex-1 text-lg sm:text-base leading-relaxed font-normal">{item}</span>
                </li>
              ) : null;
            })}
          </ul>
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{page.disclaimerclosing}</p>
        </section>
        ...
        {[
          ...
          <section key={idx} className="bg-white rounded-2xl p-4 md:p-8 shadow-lg">
            <p className="flex items-center gap-3 text-lg sm:text-base leading-relaxed mb-4 font-normal">
              <span className="text-lg sm:text-base leading-relaxed font-normal">{section.icon}</span>
              {section.title}
            </p>
            <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{section.text}</p>
          </section>
        ))}
        ...
        <section className="rounded-2xl p-4 md:p-8">
          ...
          <p className="text-lg sm:text-base leading-relaxed mb-4 font-normal">{page.contacttext}</p>
          ...
          <p className="pt-4 text-lg sm:text-base leading-relaxed mb-4 font-normal">{page.closing}</p>
        </section>
      </div>
    </PageLayout>
  );
