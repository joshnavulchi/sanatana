    ...
    >
      <div className="space-y-8" id="terms-of-service-content">
        ...
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-4 md:p-8 shadow-lg">
          <h3 className="text-lg sm:text-md font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">📜</span>
        ...
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-4 md:p-8 shadow-lg">
          <h4 className="text-lg sm:text-md font-bold text-gray-900 mb-4 flex items-center gap-3">
        ...
        {/* User Conduct */}
        <section className="bg-white border-2 border-amber-100 rounded-2xl p-4 md:p-8 shadow-lg">
          <h5 className="text-lg sm:text-md font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">👤</span>
        ...
        <section className="bg-gradient-to-br from-amber-50 to-orange-50 border-l-4 border-amber-500 rounded-lg p-4 md:p-8 shadow-lg">
          <h6 className="text-lg sm:text-md font-bold text-gray-900 mb-4 flex items-center gap-3">
            <span className="text-2xl">⚠️</span>
        ...
        {[
          ...
          <section key={idx} className="bg-white border-2 border-amber-100 rounded-2xl p-4 md:p-8 shadow-lg">
            <p className="text-lg sm:text-md font-bold text-gray-900 mb-4 flex items-center gap-3">
