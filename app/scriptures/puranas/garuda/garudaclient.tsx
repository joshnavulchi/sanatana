  ...
  return (
    <div className="space-y-6 mt-12">
      ...
      <div className="flex items-center justify-center gap-3 mb-8">
        ...
        <span className="text-base md:text-md text-amber-800 font-semibold tracking-wide animate-fade-in">💬 Conversation</span>
        ...
        return (
          ...
          >
            ...
            `}>
              ...
              {item.speaker && (
                <div className={`
                  inline-flex items-center gap-2 mb-2 px-4 py-2 ${isEven ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white' : 'bg-gradient-to-r from-amber-500 to-orange-600 text-white'} rounded-full shadow-lg font-semibold text-base md:text-md ${isEven ? '' : 'ml-auto'} animate-fade-in
                `}>
                  <span className="text-xl md:text-lg">{isEven ? '🧘' : '🕉️'}</span>
              ...
              {item.message && (
                ...
                >
                  {/* Message text */}
                  <p className="text-gray-800 text-base md:text-md leading-relaxed m-0 ">
                    {item.message}
                  </p>
                  ...
                  text-white text-base md:text-md md:text-sm
