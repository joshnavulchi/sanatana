    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <p className="text-md md:text-lg font-semibold text-amber-900 tracking-wide uppercase">Written by: {page.author}</p>
              ...
              {page.introduction.what_is_ramayanam && (
                <div className="bg-white border-l-4 border-orange-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-r-xl">
                  <div className="bg-orange-100 px-5 py-3 border-b-2 border-orange-200">
                    <h4 className="text-md md:text-lg font-bold text-orange-900 flex items-center gap-2">
                      <span className="text-2xl">📖</span>
                      What is Ramayanam?
                    </h4>
                  </div>
                  <div className="p-5">
                    <p className="text-md md:text-lg text-gray-700 leading-relaxed">{page.introduction.what_is_ramayanam}</p>
                  </div>
                </div>
              )}
              {page.introduction.who_wrote_it && (
                <div className="bg-white border-l-4 border-amber-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-r-xl">
                  <div className="bg-amber-100 px-5 py-3 border-b-2 border-amber-200">
                    <h5 className="text-md md:text-lg font-bold text-amber-900 flex items-center gap-2">
                      <span className="text-2xl">✍️</span>
                      Who Wrote It?
                    </h5>
                  </div>
                  <div className="p-5">
                    <p className="text-md md:text-lg text-gray-700 leading-relaxed">{page.introduction.who_wrote_it}</p>
                  </div>
                </div>
              )}
              {page.introduction.why_it_is_important && (
                <div className="bg-white border-l-4 border-red-500 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-r-xl">
                  <div className="bg-red-100 px-5 py-3 border-b-2 border-red-200">
                    <h6 className="text-md md:text-lg font-bold text-red-900 flex items-center gap-2">
                      <span className="text-2xl">⭐</span>
                      Why It Is Important?
                    </h6>
                  </div>
                  <div className="p-5">
                    <p className="text-md md:text-lg text-gray-700 leading-relaxed">{page.introduction.why_it_is_important}</p>
                  </div>
                </div>
              )}
            </div>
                  ...
                  <div className="relative p-6">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <h6 className="text-md md:text-lg font-bold text-amber-900 group-hover:text-orange-600 transition-colors">{c.name}</h6>
                      </div>
                    </div>
                    {c.role && (
                      <p className="text-md md:text-lg text-gray-700 leading-relaxed">{c.role}</p>
                    )}
                  </div>
                </div>
              ))}
                  ...
                  <div className="pl-8 pr-6 py-5">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center border-2 border-amber-400">
                        <span className="text-md md:text-lg font-bold text-amber-700">{idx + 1}</span>
                      </div>
                      <div className="flex-1">
                        <h6 className="text-md md:text-lg font-bold text-amber-900 mb-2">{typeof ct.title === 'string' ? ct.title : ct['title']}</h6>
                        {ct.description && <p className="text-md md:text-lg text-gray-700 leading-relaxed">{ct.description}</p>}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {page.timeline.map((ev: any, idx: number) => (
                  <div key={idx} className="relative flex items-start gap-6 group">
                    <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full flex items-center justify-center border-4 border-white shadow-lg z-10">
                      <span className="text-white font-bold text-md md:text-lg">{idx + 1}</span>
                    </div>
                    <div className="flex-1 bg-white rounded-xl border-2 border-amber-200 shadow-md hover:shadow-lg transition-shadow duration-300 p-5">
                      <p className="text-md md:text-lg font-semibold text-amber-900">{typeof ev === 'string' ? ev : ev.event}</p>
                      {typeof ev === 'object' && ev.desc && <p className="text-md md:text-lg text-gray-600 mt-2">{ev.desc}</p>}
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div key={idx} className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl border-2 border-red-300 shadow-lg hover:shadow-xl transition-all duration-300 p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-8 h-8 bg-red-500 rounded-lg flex items-center justify-center">
                      <span className="text-white text-md md:text-lg">🔸</span>
                    </div>
                    <h6 className="text-md md:text-lg font-bold text-red-900 capitalize">{key.replace(/_/g, ' ')}</h6>
                  </div>
                  <p className="text-md md:text-lg text-gray-700 leading-relaxed ">{value}</p>
                </div>
              ))}
            </div>
          </section>
                        ...
                        {kanda.narrative && (
                          <div className="mb-6 pl-0 md:pl-22">
                            <div className="bg-white bg-opacity-70 rounded-xl p-5 border border-gray-200">
                              <p className="text-md md:text-lg text-gray-800 leading-relaxed line-clamp-4">
                        ...
                        {kanda.lessons && (
                          <div className="mb-6 pl-0 md:pl-22">
                            <div className="bg-white bg-opacity-90 rounded-xl p-5 border-l-4 border-amber-500">
                              <p className="text-md md:text-lg font-bold text-amber-700 uppercase tracking-wider mb-2">📚 Key Lessons</p>
                              <p className="text-md md:text-lg text-gray-700 leading-relaxed">{kanda.lessons}</p>
                            </div>
                          </div>
                        )}
              ...
              <div className="space-y-6">
                {Object.entries(page.cultural_importance).map(([key, value]: [string, any], idx: number) => (
                  <div key={idx} className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-md md:text-lg font-bold text-amber-900 mb-2 capitalize">{key.replace(/_/g, ' ')}</h3>
