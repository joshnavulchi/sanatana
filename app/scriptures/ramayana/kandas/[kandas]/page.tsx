                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-center mb-4">
                    <div className="bg-white bg-opacity-20 backdrop-blur-sm px-6 py-2 rounded-full border-2 border-white border-opacity-50">
                      <p className="text-white text-xl font-bold uppercase tracking-widest">Sacred Epic of Ramayana</p>
                    </div>
                  </div>
              ...
              <div className="p-8 md:p-12">
                {kanda ? (
                  ...
                  <div className="text-center py-16">
                    ...
                    <p className="text-xl text-gray-500 mt-2">Please check back later or explore other chapters.</p>
                  </div>
                )}
              </div>
