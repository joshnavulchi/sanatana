            ...
            <div className={`bg-gradient-to-r ${classes.footerBg} px-3 md:px-6 py-12 border-t-2 ${classes.footerBorder}`}>
              <div className="flex justify-center">
                <Link
                  ...
                  className={`inline-flex items-center gap-2 bg-gradient-to-r ${classes.buttonBg} text-white px-3 py-1 rounded-sm shadow-md hover:shadow-xl transition-all duration-300`}
                >
