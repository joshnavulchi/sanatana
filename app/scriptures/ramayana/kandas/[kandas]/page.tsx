            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-4">
                <div className="bg-white bg-opacity-20 backdrop-blur-sm px-6 py-2 rounded-full border-2 border-white border-opacity-50">
                  <p className="text-white text-lg md:text-md font-bold uppercase tracking-widest">Sacred Epic of Ramayana</p>
                </div>
              </div>
          ...
          <div className="p-8 md:p-12">
            {kanda ? (
                ...
                {kanda.narrative && (
                  <section className="mb-10">
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute -left-4 -top-4 text-6xl text-gray-200  leading-none">“</div>
                ...
                {kanda.lessons && (
                  <section className={`bg-gradient-to-br ${classes.sectionBg} rounded-2xl border-2 ${classes.sectionBorder} shadow-xl p-8`}>
                    ...
                    <div className="relative bg-white bg-opacity-60 rounded-xl p-6 border-l-4 border-amber-500">
                      <p className="text-lg md:text-md text-gray-800 leading-relaxed italic">
                        {kanda.lessons}
                      </p>
                    </div>
                  </section>
              ...
              <div className="text-center py-16">
                ...
                <p className="text-xl md:text-lg md:text-md text-gray-600 font-medium">Content not available for this chapter.</p>
                <p className="text-lg md:text-md text-gray-500 mt-2">Please check back later or explore other chapters.</p>
              </div>
            )}
          </div>
