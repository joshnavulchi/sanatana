                    ...
                    <div className="relative p-6">
                      ...
                      <div className="relative z-10 pt-4 flex items-center gap-2 text-amber-800 font-semibold text-sm hover:gap-3 transition-all duration-300">
                        <Link
                          ...
                          className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-orange-600 hover:to-amber-600 text-white px-3 py-1 rounded-md shadow-md hover:shadow-xl transition-all duration-300"
                        >
                          <span>Read Part</span>
