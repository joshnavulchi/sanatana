      ...
      <div className="divide-y divide-orange-200">
        {Object.entries(value).map(([k, v]: [string, any], idx: number) => (
          <div key={k + idx} className="py-2">
            <div className="text-orange-700 font-semibold mb-1 text-xl md:text-lg md:text-md flex items-center">
        ...
        <div className="p-3 md:p-6">
          {part ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-xl md:text-lg md:text-md text-gray-600 font-medium">Content not available for this part.</p>
              <p className="text-xl md:text-lg md:text-md text-gray-500 mt-2">Please check back later or explore other parts.</p>
            </div>
          )}
        </div>
