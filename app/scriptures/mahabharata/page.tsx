    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto">
          {/* Hero Header Section */}
          <section className="relative mb-12 bg-blue-50 overflow-hidden">
            <div className="px-8 py-10">
              <div className="text-center mb-6">
                <div className="inline-block relative">
                  <h3 className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 mb-3">
                    {page.title}
                  </h3>
              ...
              {page.description && (
                <div className="max-w-3xl mx-auto">
                  <p className="text-center text-base text-blue-800 leading-relaxed italic font-medium px-4">
                    ...
                    <div className="relative p-6">
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-blue-900 group-hover:text-indigo-600 transition-colors">{c.name}</h3>
                        </div>
                      </div>
                      {c.description && (
