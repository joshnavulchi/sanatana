...
const ns = (_localeObj && ((_localeObj as any)['scriptures_mahabharata'] || ((_localeObj as any).sharable_strings && (_localeObj as any).sharable_strings['scriptures_mahabharata']))) || {};
