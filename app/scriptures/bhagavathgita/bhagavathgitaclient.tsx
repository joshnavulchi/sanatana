  ...
  if (isLoading && !page.title) {
    return (
      <PageLayout
        ...
        title={page.title || 'Bhagavathgita'}
        breadcrumbs={[{ labelKey: 'Home', href: '/' }, { label: 'Bhagavathgita' }]}
        className="layout-md"
      >
      ...
      >
        ...
        <div className="relative my-3 px-3 py-6 bg-gradient-to-br from-amber-50 via-orange-50 to-amber-50 overflow-hidden">
          ...
          <div className="relative z-10 text-center space-y-6">
            ...
            <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-amber-700 via-orange-600 to-amber-700 bg-clip-text">
              {page.title}
            </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {(page.chapters || []).map((item: any, i: number) => {
            ...
            const enChapter = (locale as any)?.page?.chapters?.[Number(chapNum) - 1];
