  ...
  return (
    <>
      ...
      >
        ...
        <p className="mb-6 text-md text-center text-slate-600">
        ...
        <div className="space-y-8">
          ...
          {page.main_characters && page.main_characters.length > 0 && (
            <section className="border border-slate-100 rounded-lg">
              <h3 className="text-md font-semibold text-slate-800 mb-3">Main Characters</h3>
                ...
                {page.main_characters.map((c: any, idx: number) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      {c.note ? <div className="mt-1 text-xs md:base-sm text-slate-500">{c.note}</div> : null}
                    </div>
                  </article>
                ))}
              </div>
          ...
          {page.important_places && page.important_places.length > 0 && (
            <section className="">
              <h4 className="text-md font-semibold text-amber-800 mb-3">Important Places</h4>
          ...
          {page.timeline && page.timeline.length > 0 && (
            <section className="bg-white border border-slate-100 rounded-lg shadow-sm">
              <h6 className="text-md font-semibold text-slate-800 mb-4">Timeline</h6>
          ...
          {page.core_themes && page.core_themes.length > 0 && (
            <section>
              <p className="text-md font-semibold text-amber-800 mb-3">Core Themes</p>
