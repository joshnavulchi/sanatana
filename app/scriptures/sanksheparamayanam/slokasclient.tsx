    ...
    <section className="max-w-7xl mx-auto">
      <header className="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-md md:text-md text-slate-500">
                  ...
                  <div className="text-md text-slate-700 leading-relaxed">
                    ...
                    {context.length > 220 ? (
                      <button
                        ...
                        className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-md md:text-md bg-amber-50 text-amber-700 border border-amber-100 shadow-sm hover:brightness-105 transition"
