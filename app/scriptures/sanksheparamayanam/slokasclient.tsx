    ...
    <section className="max-w-7xl mx-auto">
      <header className="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-base md:text-md text-slate-500">
            ...
            >
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="ml-4 flex flex-col items-end gap-2">
                  ...
                  <span className="text-xl md:text-lg text-slate-700">{idx + 1}</span>
                </div>
              </div>

              <div className="mt-4">
                {context ? (
                  <div className="text-xl md:text-lg text-slate-700 leading-relaxed">
                    <p className={`${isExpanded ? "" : "line-clamp-[8]"}`}>{isExpanded ? context : previewContext}</p>
                    {context.length > 220 ? (
                      <button
                        onClick={() => toggleExpand(idx)}
                        className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-base md:text-md bg-amber-50 text-amber-700 border border-amber-100 shadow-sm hover:brightness-105 transition"
                  ...
                  <p className="text-xl md:text-lg text-slate-700">No context available.</p>
                )}
              </div>
      ...
      <div className="mt-10 flex justify-center">
        <button
          ...
          className={`cursor-pointer px-6 py-3 rounded-full text-xl md:text-lg shadow-xl transition transform hover:-translate-y-0.5 ${visible >= maxVisible
