...
const WorldMap = () => {
  ...
  return (
    <div className="w-full min-h-[200px] m-0 p-0 overflow-hidden relative text-base leading-relaxed font-normal">
      <style>{labelStyle}</style>
      <div className="absolute top-5 left-0 z-10 bg-white/90 rounded-sm px-3 py-1 mx-3 shadow-md text-base leading-relaxed font-normal">
      ...
      {error && (
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white bg-opacity-95 text-red-700 px-4 py-3 rounded shadow-lg z-50 text-base leading-relaxed font-normal">
          {error}
        </div>
      )}
    </div>
