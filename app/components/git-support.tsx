          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                ...
                target="_blank"
                className="group/btn relative px-4 md:px-8 py-3 bg-white/90 hover:bg-white text-md rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 no-underline overflow-hidden">
              ...
              <Link
                href="https://github.com/vulchivijay/sanatana"
                target="_blank"
                className="group/btn px-4 md:px-8 py-3 bg-transparent border-2 border-white/50 hover:border-white text-white text-md rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 no-underline backdrop-blur-sm">
