      ...
      <div className={`relative z-1 md:content-wrapper md:absolute md:top-1/2 md:left-20 md:-translate-y-1/2 p-3 sm:py-16 md:px-0 md:py-0 transition-all duration-1000 ease-out
        ...
        <div className="relative bg-black/30 backdrop-blur-xl border border-white/20 rounded-xl p-4 md:p-8 shadow-xl max-w-2xl overflow-hidden group text-white">
          ...
          <div className="relative">
            ...
            {/* Title */}
            <h4 className="text-xl md:text-2xl leading-tight drop-shadow-2xl">
              {loc?.cta?.title || 'Contribute'}
            </h4>

            {/* Subtitle */}
            <p className="text-lg sm:text-base leading-relaxed drop-shadow-lg my-4">
              {loc?.cta?.subtitle || ''}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                ...
                target="_blank"
                className="group/btn relative px-4 md:px-8 py-3 bg-white/90 hover:bg-white text-lg sm:text-base rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 no-underline overflow-hidden">
              ...
              <Link
                href="https://github.com/vulchivijay/sanatana"
                target="_blank"
                className="group/btn px-4 md:px-8 py-3 bg-transparent border-2 border-white/50 hover:border-white text-white text-lg sm:text-base rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 no-underline backdrop-blur-sm">
