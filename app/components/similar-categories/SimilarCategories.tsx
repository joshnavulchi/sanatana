              ...
              <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-amber-200/80 pt-3">
                {category.links.length > INITIAL_VISIBLE_LINKS && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full border border-amber-300 bg-amber-50 px-3 py-1.5 text-xs font-semibold tracking-wide text-amber-900 transition-colors hover:bg-amber-100"
                  >
                ...
                <Link
                  href={resolveCategoryHref(category.key)}
                  className="inline-flex items-center gap-1.5 rounded-full border border-orange-300 bg-orange-100 px-3 py-1.5 text-xs font-semibold tracking-wide text-orange-900 transition-colors hover:bg-orange-200"
                >
                  View all
