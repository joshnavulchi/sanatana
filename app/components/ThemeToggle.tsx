...
export default function ThemeToggle() {
  ...
  return (
    <div className="relative">
      <button
        className="w-6 h-6 group relative inline-flex items-center bg-gradient-to-r from-amber-50 to-orange-50 hover:from-amber-100 hover:to-orange-100 transition-all duration-300 transform hover:scale-105 text-amber-800 cursor-pointer"
