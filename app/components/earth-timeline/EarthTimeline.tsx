    ...
    <div className={`relative w-full ${className}`}>
      ...
      <div className="relative bg-gradient-to-b from-gray-900 via-blue-950 to-gray-900 rounded-3xl overflow-hidden shadow-2xl border-4 border-amber-500/30">
        ...
        {currentPeriod.tectonicActivity === 'high' && (
          <div className="absolute top-4 right-4 z-10 flex items-center gap-2 px-4 py-2 bg-red-500/20 border border-red-500/50 rounded-full backdrop-blur-sm">
            ...
            <span className="text-red-300 text-md md:text-md font-semibold">High Tectonic Activity</span>
          </div>
        )}
        ...
        <div className="relative flex items-start gap-6">
          ...
          <div className="flex-1">
            <h3 className="text-2xl font-bold text-white mb-3 flex items-center gap-3">
              {currentPeriod.name}
              {currentPeriod.tectonicActivity === 'high' && (
                <span className="px-3 py-1 bg-red-500/20 border border-red-500/50 rounded-full text-red-300 text-md md:text-md font-semibold">
                  🔥 Active Plates
                </span>
              )}
            </h3>
      ...
      <div className="mt-8 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-center gap-4 mb-4">
          ...
          <div className="text-md md:text-md text-gray-400">
            ...
            {timelineData.map((period, index) => (
              ...
              >
                ...
                <div className={`
                  ...
                  bg-gray-900 border border-gray-700 text-white text-md md:text-md
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-6 border-2 border-amber-400/30 shadow-xl">
          <div className="flex items-start gap-4 mb-4">
            <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-600 rounded-lg flex items-center justify-center text-md md:text-md">
              📚
            </div>
            <div>
              <h4 className="text-md md:text-md font-bold text-white mb-2">About This Timeline</h4>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-4">
            <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700 flex-1">
              ...
              <p className="text-gray-400 text-md md:text-md">Stable continental positions with minimal tectonic movement</p>
            </div>
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
              ...
              <p className="text-gray-400 text-md md:text-md">Continents actively drifting, mountain ranges forming</p>
            </div>
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
              ...
              <p className="text-gray-400 text-md md:text-md">Major rifting, collisions, and supercontinent formation</p>
            </div>
          </div>

          <div className="mt-4 pt-4 border-t border-gray-700">
            <p className="text-md md:text-md text-gray-400 text-center">
