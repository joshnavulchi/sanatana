...
const timelineData = [
  ...
  },
  {
    ...
    continents: [
      ...
      // Europe
      "M 480 260 Q 510 250 545 255 Q 580 262 610 280 Q 635 300 640 330 Q 642 360 630 385 Q 615 405 590 415 Q 560 420 530 415 Q 500 408 480 390 Q 465 370 463 345 Q 462 315 480 260 Z",
      // Africa
      "M 460 400 Q 490 385 530 390 Q 570 398 600 425 Q 625 452 630 490 Q 630 530 615 565 Q 595 595 565 615 Q 530 630 490 625 Q 455 615 435 585 Q 420 555 423 520 Q 427 480 460 400 Z",
      // Asia
      "M 550 240 Q 610 230 680 240 Q 750 255 810 285 Q 860 315 880 355 Q 895 395 885 440 Q 870 480 840 510 Q 800 535 750 545 Q 690 550 630 535 Q 580 520 550 490 Q 530 465 525 435 Q 520 400 550 240 Z",
      // Australia
      "M 730 490 Q 760 480 795 485 Q 830 495 855 520 Q 875 545 870 575 Q 865 605 845 625 Q 820 640 785 640 Q 750 635 725 615 Q 705 590 705 560 Q 705 525 730 490 Z",
      // Antarctica
      "M 350 670 Q 420 660 500 665 Q 580 670 640 685 Q 690 700 700 725 Q 705 750 680 765 Q 650 775 600 775 Q 520 770 440 760 Q 370 745 340 720 Q 320 700 330 680 Q 340 665 350 670 Z"
    ],
    rotation: 20,
    color: "#228B22",
  ...
  {
    year: 10000000,
    name: "10M Years Future",
    description: "Africa moves north, Mediterranean closes",
    continents: [
      // North America (further west)
  ...
  },
  {
    ...
    continents: [
      ...
      // Small landmass
      "M 750 570 Q 780 565 815 572 Q 850 582 875 605 Q 895 630 890 665 Q 885 695 860 715 Q 830 730 795 725 Q 760 720 740 695 Q 725 670 730 640 Q 735 605 750 570 Z"
    ],
    rotation: 30,
    color: "#32CD32",
    tectonicActivity: "high"
  },
  {
    ...
    continents: [
      ...
      // Small fragment
      "M 570 720 Q 600 715 635 722 Q 670 732 695 755 Q 715 780 710 815 Q 705 845 680 865 Q 650 880 615 875 Q 580 870 560 850 Q 545 825 550 795 Q 555 760 570 720 Z"
    ],
    rotation: 35,
    color: "#90EE90",
    tectonicActivity: "high"
  },
  {
    ...
    continents: [
      ...
      "M 630 740 Q 665 735 705 742 Q 745 752 775 775 Q 800 800 795 835 Q 790 870 760 890 Q 725 905 685 900 Q 650 895 630 875 Q 615 850 620 820 Q 625 785 630 740 Z"
    ],
    rotation: 40,
    color: "#9ACD32",
    tectonicActivity: "moderate"
  ...
  return (
    <div className={`relative w-full ${className}`}>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 text-xl md:text-lg">
      ...
      <div className="relative bg-gradient-to-b from-gray-900 via-blue-950 to-gray-900 rounded-3xl overflow-hidden shadow-2xl border-4 border-amber-500/30">
        ...
        {currentPeriod.tectonicActivity === 'high' && (
          <div className="absolute top-4 right-4 z-10 flex items-center gap-2 px-4 py-2 bg-red-500/20 border border-red-500/50 rounded-full backdrop-blur-sm">
            ...
            <span className="text-red-300 text-base md:text-md font-semibold">High Tectonic Activity</span>
          </div>
        )}
        ...
        <div className="relative flex items-start gap-6">
          ...
          <div className="flex-1">
            <h3 className="text-2xl font-bold text-white mb-3 flex items-center gap-3">
              {currentPeriod.name}
              {currentPeriod.tectonicActivity === 'high' && (
                <span className="px-3 py-1 bg-red-500/20 border border-red-500/50 rounded-full text-red-300 text-base md:text-md font-semibold">
                  🔥 Active Plates
                </span>
              )}
            </h3>
            <p className="text-gray-300 leading-relaxed text-xl md:text-lg mb-3">{currentPeriod.description}</p>
      ...
      <div className="mt-8 flex flex-col gap-6">
            ...
            {timelineData.map((period, index) => (
              ...
              >
                ...
                <div className={`
                  ...
                  bg-gray-900 border border-gray-700 text-white text-base md:text-md
                ...
                `}>
                  ...
                  <div className="text-gray-300 text-base md:text-md md:text-sm mt-1">{formatYear(period.year)}</div>
                  {/* Arrow */}
                  <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-gray-900 border-r border-b border-gray-700 rotate-45" />
                </div>

                {/* Period indicator */}
                <div className="absolute inset-0 flex items-center justify-center text-base md:text-md md:text-sm font-bold text-white">
                  {index + 1}
                </div>
        ...
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-6 border-2 border-amber-400/30 shadow-xl">
          <div className="flex items-start gap-4 mb-4">
            <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-600 rounded-lg flex items-center justify-center text-base md:text-md">
              📚
            </div>
            <div>
              <h4 className="text-base md:text-md font-bold text-white mb-2">About This Timeline</h4>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-4">
            <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700 flex-1">
              ...
              <p className="text-gray-400 text-base md:text-md">Stable continental positions with minimal tectonic movement</p>
            </div>
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
              ...
              <p className="text-gray-400 text-base md:text-md">Continents actively drifting, mountain ranges forming</p>
            </div>
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
              ...
              <p className="text-gray-400 text-base md:text-md">Major rifting, collisions, and supercontinent formation</p>
            </div>
          </div>

          <div className="mt-4 pt-4 border-t border-gray-700">
            <p className="text-base md:text-md text-gray-400 text-center">
