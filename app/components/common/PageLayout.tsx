  ...
  return (
    <>
      ...
      <main className={`px-3 ${wrapper} bg-gradient-to-br from-amber-50 via-pink-50 to-rose-100 min-h-[80vh] rounded-3xl shadow-2xl border-4 border-amber-100 animate-fadeInUp`}>
        <div className="w-full text-base sm:text-lg leading-relaxed font-normal">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0 text-base sm:text-lg leading-relaxed font-normal">
            <Breadcrumbs items={breadcrumbs} locale={locale} />
            <WordCount />
          </div>
          {/* Hero Header Section */}
          <div className="relative my-6 overflow-hidden text-base sm:text-lg leading-relaxed font-normal animate-fadeInUp">
            <div className="px-4 py-5 text-base sm:text-lg leading-relaxed font-normal">
              <div className="text-center text-base sm:text-lg leading-relaxed font-normal">
                <div className="inline-block relative text-base sm:text-lg leading-relaxed font-normal">
              ...
              {description && (
                <div className="max-w-3xl mx-auto text-base sm:text-lg leading-relaxed font-normal py-10 animate-fadeIn delay-200">
                  <p className="text-center text-rose-700 italic px-4 text-base sm:text-lg leading-relaxed mb-4 font-normal">
      ...
      {showSimilarCategories && (
        <>
          ...
          >
            <span className="flex flex-col items-center gap-1 text-base sm:text-lg leading-relaxed font-normal">
              <svg
              ...
              <span className="uppercase text-[#9a3412] [writing-mode:vertical-lr] text-base sm:text-lg leading-relaxed font-normal">
                Explore
              </span>
            </span>
          </button>
          ...
          {panelOpen && (
            <div
              className="fixed inset-0 z-40 bg-[#5b2d12]/20 backdrop-blur-[2px] transition-opacity duration-300 text-base sm:text-lg leading-relaxed font-normal"
          ...
          >
            {/* Panel header */}
            <div className="flex items-center justify-between border-[#d8a25a]/30 px-5 py-4 text-base sm:text-lg leading-relaxed font-normal">
              <div className="flex items-center gap-2 text-base sm:text-lg leading-relaxed font-normal">
                <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#7a2e1f] text-[#fff4df] text-base sm:text-lg leading-relaxed font-normal">✦</span>
                <span className="uppercase text-[#7a2e1f] text-base sm:text-lg leading-relaxed font-normal">Explore</span>
              </div>
              <button
                type="button"
                onClick={() => setPanelOpen(false)}
            ...
            {/* Accent bar */}
            <div className="h-0.5 w-full text-base sm:text-lg leading-relaxed font-normal" />

            {/* Scrollable content */}
            <div className="flex-1 overflow-y-auto px-4 py-5 text-base sm:text-lg leading-relaxed font-normal">
              <SimilarCategories />
            </div>
