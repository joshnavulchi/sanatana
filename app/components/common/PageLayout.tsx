    ...
    <>
      ...
      <main className={`px-3 ${wrapper} min-h-[80vh] shadow-xl border-l-4 border-r-4 border-amber-100 animate-fadeInUp`}>
        <div className="w-full text-lg sm:text-base leading-relaxed font-normal">
          ...
          {/* Hero Header Section */}
          <div className="relative my-6 overflow-hidden text-lg sm:text-base leading-relaxed font-normal animate-fadeInUp">
      ...
      {showSimilarCategories && (
        <>
          ...
          {panelOpen && (
            <div
              className="fixed inset-0 z-40 bg-[#5b2d12]/20 backdrop-blur-[2px] transition-opacity duration-300 text-lg sm:text-base leading-relaxed font-normal"
          ...
          >
            {/* Panel header */}
            <div className="flex items-center justify-between border-[#d8a25a]/30 px-5 py-4 text-lg sm:text-base leading-relaxed font-normal">
              <div className="flex items-center gap-2 text-lg sm:text-base leading-relaxed font-normal">
                <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#7a2e1f] text-[#fff4df] text-lg sm:text-base leading-relaxed font-normal">✦</span>
                <span className="uppercase text-[#7a2e1f] text-lg sm:text-base leading-relaxed font-normal">Explore</span>
              </div>
              <button
                type="button"
                onClick={() => setPanelOpen(false)}
            ...
            {/* Accent bar */}
            <div className="h-0.5 w-full text-lg sm:text-base leading-relaxed font-normal" />

            {/* Scrollable content */}
            <div className="flex-1 overflow-y-auto px-4 py-5 text-lg sm:text-base leading-relaxed font-normal">
              <SimilarCategories />
            </div>
