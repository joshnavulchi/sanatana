...
export default function WelcomePageOverlay() {
  ...
  return (
    <section className="w-full px-3 py-4 md:py-6" aria-label="Welcome message">
      <div
        className={`
          max-w-4xl mx-auto
      ...
      >
        ...
        <div className="relative">
          <button
            ...
            className="cursor-pointer absolute top-4 right-4 z-30 w-9 h-9 bg-white/80 backdrop-blur-sm rounded-full shadow-md flex items-center justify-center transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-amber-200"
          >
          ...
          <div className="bg-white/75 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-4">
              ...
              <h2 className="text-3xl md:text-3xl font-semibold tracking-tight leading-tight text-amber-800">
                Namaste & Welcome
              </h2>
