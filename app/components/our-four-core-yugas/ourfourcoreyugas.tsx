      ...
      <div className="content-wrapper ourfour-coreyugas">
        <div className="flex flex-col md:flex-row items-start justify-start">
          <div className="w-full md:w-1/3">
            <p className="text-medium">{t('home.ourFourCoreYugas.title', loc)}</p>
          </div>
          <div className="w-full md:w-2/3">
            <div>
              <p className="text-small">{t('home.ourFourCoreYugas.satyaTitle', loc)}</p>
            ...
            <div>
              <p className="text-small">{t('home.ourFourCoreYugas.tretaTitle', loc)}</p>
            ...
            <div>
              <p className="text-small">{t('home.ourFourCoreYugas.dvaparaTitle', loc)}</p>
            ...
            <div>
              <p className="text-small">{t('home.ourFourCoreYugas.kaliTitle', loc)}</p>
