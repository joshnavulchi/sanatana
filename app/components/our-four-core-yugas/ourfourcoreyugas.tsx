      ...
      <div className="content-wrapper ourfour-coreyugas">
        <div className="flex flex-col md:flex-row items-start justify-start">
          <div className="w-full md:w-1/2">
            <p>{t('home.ourFourCoreYugas.title', loc)}</p>
          </div>
          <div className="w-full md:w-1/2">
            <div>
              <p>{t('home.ourFourCoreYugas.satyaTitle', loc)}</p>
            ...
            <div>
              <p>{t('home.ourFourCoreYugas.tretaTitle', loc)}</p>
            ...
            <div>
              <p>{t('home.ourFourCoreYugas.dvaparaTitle', loc)}</p>
            ...
            <div>
              <p>{t('home.ourFourCoreYugas.kaliTitle', loc)}</p>
