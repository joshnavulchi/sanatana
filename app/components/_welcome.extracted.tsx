...
const page = {
  clarity_devotion: "clarity, devotion, and divine grace",
  close: "Close",
  deeply_honored: "We are deeply honored and blessed by your presence here.",
  do_not: "Do not show this welcome message again",
  eternal_truths: "eternal truths of Sanātana Dharma",
  may_journey: "May your journey through these ancient teachings bring you",
  namaste_welcome: "Namaste & Welcome",
  thank_taking: "Thank you for taking this sacred step towards understanding and embracing the",
  timeless_wisdom: "— the timeless wisdom that illuminates the path to inner peace, righteousness, and spiritual awakening.",
  truth_alone: "Truth Alone Triumphs · Dharma Protects Those Who Protect It"
};
...
export default function WelcomePage() {
  ...
  return <div className="min-h-[60vh] flex items-center justify-center px-3">
      <div className={`
          max-w-4xl mx-auto
          ...
          ">
            ...
            <div className="relative z-10 text-center space-y-6">
              ...
              <div className="flex items-center justify-center gap-2 py-4">
                <div className="w-2 h-2 rounded-full bg-amber-400 animate-bounce" style={{
                animationDelay: '0ms'
              }} />
                <div className="w-2 h-2 rounded-full bg-orange-400 animate-bounce" style={{
              ...
              <div className="space-y-4 max-w-2xl mx-auto">
                <p className="text-xl md:text-lg leading-relaxed"> {page.deeply_honored} </p>
                <p className="text-xl md:text-lg text-gray-600 leading-relaxed"> {page.thank_taking} <span className="font-semibold text-amber-700 "> {page.eternal_truths}</span> {page.timeless_wisdom} </p>
                <p className="text-xl md:text-lg text-gray-600 leading-relaxed"> {page.may_journey} <span className="font-semibold text-orange-600"> {page.clarity_devotion}</span>.
                </p>
              </div>
              ...
              <div className="pt-6 space-y-2">
                ...
                <p className="text-xl md:text-lg text-gray-400  italic"> {page.truth_alone} </p>
              </div>
              ...
              <div className="pt-6 border-t border-amber-200/30 mt-8 flex flex-col items-center gap-4">
                <label className="flex items-center justify-center gap-3 cursor-pointer group">
                  <input type="checkbox" checked={doNotShowAgain} onChange={e => setDoNotShowAgain(e.target.checked)} className="
                      w-5 h-5 
                      ...
                      transition-all
                    " />
                  <span className="text-xl md:text-lg text-gray-600 group-hover:text-amber-700 transition-colors"> {page.do_not} </span>
                </label>
                ...
                backdropFilter: 'blur(16px)'
                  ...
                  <span className="relative z-10 tracking-widest drop-shadow-lg text-xl md:text-lg group-hover:text-amber-900  group-active:text-orange-700 transition-colors duration-200 select-none">{page.close}</span>
                </button>
              </div>
            </div>
          </div>
