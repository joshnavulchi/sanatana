            ...
            >
              ...
              >
                <div className="flex items-start gap-4 flex-1">
                  <div className={`
                    flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-xl md:text-lg md:text-md font-bold transition-all duration-300
                    ${open
                  ...
                  <span className={`
                    font-semibold text-xl md:text-lg md:text-md md:text-lg md:text-md leading-relaxed transition-colors duration-300
                    ${open
                      ? 'text-amber-900 '
