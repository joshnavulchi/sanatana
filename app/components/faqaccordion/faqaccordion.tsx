            ...
            >
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  <div className={`
                    flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-base sm:text-lg font-bold transition-all duration-300
                    ${open
                  ...
                  <span className={`text-base sm:text-lg leading-relaxed transition-colors duration-300
                    ${open
                      ? 'text-amber-900 '
