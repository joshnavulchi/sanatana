...
export default function WordCountDisplay({ selector, debounce = 250, hideWhenZero = true, minUniqueThreshold = 800 }: WordCountProps) {
  ...
  return (
    <span className="wordcount text-md leading-relaxed font-normal" role="status" aria-live="polite">
      <span className="label text-md leading-relaxed font-normal">Read time:</span>
      <span className="value text-md leading-relaxed font-normal">{timeLabel}</span>
    </span>
  );
}
