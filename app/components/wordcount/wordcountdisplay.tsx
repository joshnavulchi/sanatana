...
export default function WordCountDisplay({ selector, debounce = 250, hideWhenZero = true, minUniqueThreshold = 800 }: WordCountProps) {
  ...
  return (
    <span className="wordcount text-base leading-relaxed font-normal" role="status" aria-live="polite">
      <span className="label text-base leading-relaxed font-normal">Read time:</span>
      <span className="value text-base leading-relaxed font-normal">{timeLabel}</span>
    </span>
  );
}
