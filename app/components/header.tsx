      ...
      <div className="flex items-center justify-between px-4 sm:px-2 lg:px-6 py-1 shadow-sm">
        ...
        <div>
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-2xl/10 md:text-3xl/14 font-extrabold text-transparent bg-clip-text bg-linear-to-r from-amber-600 via-rose-600 to-indigo-700 drop-shadow-xl">
              {siteTitle}
            </span>
          </Link>
        </div>
