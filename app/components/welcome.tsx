        ...
        <div className="relative">
          ...
          ">
            ...
            <div className="relative z-10 text-center space-y-6">
              ...
              {/* Sanskrit blessing */}
              <p className="text-xl md:text-lg md:text-md md:text-2xl
              ...
              <div className="pt-6 space-y-2">
                <p className="text-xl md:text-lg md:text-mdtext-amber-700  font-medium tracking-wide">
              ...
              <div className="pt-6 border-t border-amber-200/30 mt-8 flex flex-col items-center gap-4">
                <label className="flex items-center justify-center gap-3 cursor-pointer group">
                  <input
                    ...
                    "
                  />
                  <span className="text-lg md:text-md text-gray-600 group-hover:text-amber-700 transition-colors">
                ...
                >
                  ...
                  <span className="relative z-10 tracking-widest drop-shadow-lg text-lg md:text-md group-hover:text-amber-900  group-active:text-orange-700 transition-colors duration-200 select-none">Close</span>
                </button>
              </div>
            </div>
          </div>
