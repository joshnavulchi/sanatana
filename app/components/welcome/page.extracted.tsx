        ...
        <div className="
          ...
          <div className="relative z-10 text-center space-y-6">
            ...
            <div className="pt-6 space-y-2">
              ...
              <p className="text-xs md:text-sm text-gray-500 italic"> {page.truth_alone} </p>
            </div>
            ...
            <div className="pt-6 border-t border-amber-200/30 mt-8 flex flex-col items-center gap-4">
              ...
              <button onClick={handleClose} className="cursor-pointer px-10 py-2 rounded-full bg-white/20 text-amber-700 font-extrabold border-2 border-white shadow-2xl shadow-amber-400/40 backdrop-blur-2xl transition-all duration-300 relative overflow-hidden group focus:outline-none focus:ring-4 focus:ring-amber-300/60 active:scale-95 mt-2" style={{
                ...
                <span className="relative z-10 tracking-widest drop-shadow-lg text-lg group-hover:text-amber-900 group-active:text-orange-700 transition-colors duration-200 select-none">{page.close}</span>
              </button>
            </div>
          </div>
        </div>
