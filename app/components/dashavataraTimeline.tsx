      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative">
          ...
          <div className="space-y-10">
            {dashavatara.sort((a: Avatar, b: Avatar) => a.order - b.order).map((avatar: Avatar, index: number) => {
              const isLeft = index % 2 === 0;
              return (
                <div key={avatar.order}
                  ...
                  <div className={`w-full md:w-5/12 ${isLeft ? '' : ''
                    ...
                    <div className="bg-white border border-orange-100 rounded-2xl p-6 shadow-md hover:shadow-xl transition">
                      <h2 className="text-xl md:text-lg font-semibold text-orange-700">
                        {avatar.name}
                      </h2>
                      <p className="text-xl md:text-lg text-gray-500 mb-2">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="text-xl md:text-lg mt-1">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {avatar.associated_texts.map((text, i) => (
                          <span
                            key={i}
                            className="text-base md:text-md md:text-sm bg-orange-100 text-orange-700 px-2 py-1 rounded-full"
                          >
                            {text}
                          </span>
                        ))}
