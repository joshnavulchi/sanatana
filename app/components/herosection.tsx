        ...
        <div className="w-full flex flex-col md:flex-row items-center py-32 gap-12">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-6 shadow-2xl transform hover:scale-105 transition-transform duration-500">
                ...
                <div className="text-center space-y-4">
                  ...
                  <p className="text-white/90 text-base sm:text-lg italic">सत्यमेव जयते</p>
                  <p className="text-amber-200 text-base sm:text-lg">Truth Alone Triumphs</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`w-full transition-all text-center duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
            ...
            <div className="flex flex-col md:mx-auto md:max-w-3xl">
              ...
              {/* Description */}
              <p className="text-base sm:text-lg text-gray-100 drop-shadow-lg [text-shadow:_1px_1px_3px_rgb(0_0_0_/_70%)] mt-4">
              ...
              <div className="w-full text-center flex flex-col md:flex-row md:justify-center gap-4 mt-4">
                ...
                <Link
                  ...
                  className="group md:inline-flex px-6 py-3 bg-white/10 backdrop-blur-md hover:bg-white/20 border-2 border-white/50 hover:border-white text-white text-base sm:text-lg font-light rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 no-underline">
              ...
              <div className="flex justify-center gap-2 mt-6">
                ...
                <span className="text-base sm:text-lg drop-shadow-md text-amber-200">{hero?.scroll || 'Scroll to explore'}</span>
              </div>
            </div>
          </div>
