        ...
        <div className="w-full flex flex-col md:flex-row items-center py-16 md:py-32 md:gap-12">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 shadow-2xl transform hover:scale-105 transition-transform duration-500">
                ...
                <div className="text-center space-y-6">
                  ...
                  <p className="text-white/90 md:text-md md:text-lg  italic">सत्यमेव जयते</p>
                  <p className="text-amber-200 text-md md:text-lg">Truth Alone Triumphs</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`w-full transition-all text-center duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
            ...
            <div className="flex flex-col md:mx-auto md:max-w-3xl">
              ...
              {/* Description */}
              <p className="text-md md:text-lg text-gray-100 drop-shadow-lg [text-shadow:_1px_1px_3px_rgb(0_0_0_/_70%)] mt-6">
              ...
              <div className="w-full text-center flex flex-col md:flex-row md:justify-center gap-4 mt-6">
                <Link href={hero?.primarycta?.link ? `/${hero.primarycta.link}` : '/scriptures'}
                  className="group relative md:inline-flex px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600
                    hover:from-amber-600 hover:to-orange-700 text-white text-md md:text-lg rounded-full shadow-xl font-light hover:shadow-2xl
                ...
                <Link
                  ...
                  className="group md:inline-flex px-8 py-3 bg-white/10 backdrop-blur-md
                    ...
                    text-white text-md md:text-lg font-light rounded-full shadow-lg hover:shadow-xl
              ...
              <div className="flex justify-center gap-2 mt-6">
                ...
                <span className="text-md md:text-lg drop-shadow-md text-amber-200">{hero?.scroll || 'Scroll to explore'}</span>
              </div>
            </div>
          </div>
