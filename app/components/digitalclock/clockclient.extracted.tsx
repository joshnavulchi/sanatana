...
export default function DigitalClock({
  ...
  return <div className="fixed z-9 top-32 left-4 max-w-xs md:max-w-sm" style={{
    ...
    <div className="relative">
      ...
      <div className={`transition-all duration-300 ${visible ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} bg-white/90  shadow-2xl rounded-xl border border-gray-200  p-4 flex flex-col items-end`} style={{
        ...
        <div id="digital-clock-box" role="status" className="w-full">
          ...
          {latLng && <div className="text-xs flex flex-col text-right gap-2 mt-2">
            {sunrise && <div className="flex items-center gap-2 justify-end bg-gradient-to-r from-yellow-200 via-yellow-100 to-white rounded-lg px-2 py-1 shadow-sm mb-1">
              ...
              <span className="font-semibold text-yellow-700">{page.sunrise}</span>
              <span className="font-mono text-xs text-yellow-800">{sunrise}</span>
            </div>}
            {sunset && <div className="flex items-center gap-2 justify-end bg-gradient-to-r from-indigo-200 via-purple-100 to-white rounded-lg px-2 py-1 shadow-sm mb-1">
              ...
              <span className="font-semibold text-purple-700">{page.sunset}</span>
