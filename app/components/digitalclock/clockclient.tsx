  ...
  return (
    <div className="fixed z-9 top-32 left-4 max-w-xs md:max-w-sm" style={{ pointerEvents: 'none' }}>
      <div className="relative">
        <button
          className="absolute -top-4 -left-2 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:to-pink-600 text-white shadow-lg rounded-full px-2 py-2 text-base md:text-md md:text-sm tracking-widest border-2 border-white focus:outline-none focus:ring-4 focus:ring-pink-300 transition-all duration-300 flex cursor-pointer"
          onClick={toggle}
        ...
        >
          <div id="digital-clock-box" role="status" className="w-full">
            {showDate && <div className="text-xl md:text-lg font-bold text-gray-500 mb-1 text-right">{dateStr}</div>}
            <div className="flex items-baseline justify-end gap-2">
              <div className="flex items-baseline gap-1">
                ...
                <span className="ml-1 text-base md:text-md text-gray-600 font-semibold">{ampm}</span>
              </div>
            </div>
            {latLng && (
              <div className="text-base md:text-md md:text-sm flex flex-col text-right gap-2 mt-2">
                {sunrise && (
                  <div className="flex items-center gap-2 justify-end bg-gradient-to-r from-yellow-200 via-yellow-100 to-white rounded-lg px-2 py-1 shadow-sm mb-1">
                    ...
                    <span className="font-mono text-base md:text-md md:text-sm text-yellow-800">{sunrise}</span>
                  </div>
                )}
                {sunset && (
                  <div className="flex items-center gap-2 justify-end bg-gradient-to-r from-indigo-200 via-purple-100 to-white    rounded-lg px-2 py-1 shadow-sm mb-1">
                    ...
                    <span className="font-mono text-base md:text-md md:text-sm text-purple-800 ">{sunset}</span>
                  </div>
                )}
