      ...
      <div className="relative">
        ...
        >
          <div id="digital-clock-box" role="status" className="w-full">
            {showDate && <div className="text-md font-bold text-gray-500 mb-1 text-right">{dateStr}</div>}
            <div className="flex items-baseline justify-end gap-2">
              <div className="flex items-baseline gap-1">
                ...
                <span className="ml-1 text-md md:text-md text-gray-600 font-semibold">{ampm}</span>
              </div>
            </div>
            {latLng && (
              <div className="text-sm flex flex-col text-right gap-2 mt-2">
                {sunrise && (
                  <div className="flex items-center gap-2 justify-end bg-gradient-to-r from-yellow-200 via-yellow-100 to-white rounded-lg px-2 py-1 shadow-sm mb-1">
                    ...
                    <span className="font-mono text-sm text-yellow-800">{sunrise}</span>
                  </div>
                )}
                {sunset && (
                  <div className="flex items-center gap-2 justify-end bg-gradient-to-r from-indigo-200 via-purple-100 to-white    rounded-lg px-2 py-1 shadow-sm mb-1">
                    ...
                    <span className="font-mono text-sm text-purple-800 ">{sunset}</span>
                  </div>
                )}
