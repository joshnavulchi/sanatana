      ...
      <div className="bg-gradient-to-br from-white via-amber-50/30 to-orange-50/30 rounded-3xl shadow-2xl border-2 border-amber-200/50 overflow-hidden">
        ...
        <div className="relative bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 p-8 text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-xl md:text-lg md:text-md">We&apos;d love to hear from you</p>
          </div>
        </div>
        ...
        <div className="p-8 space-y-6">
          {usedFields.map((f) => (
            <div key={f.name} className="group">
              <label className="block text-xl md:text-lg md:text-md font-semibold  mb-2 flex items-center gap-2">
          ...
          {successMessage && (
            <div className="flex items-center gap-3 p-4 bg-green-50 border-2 border-green-200 rounded-xl text-green-700 animate-fade-in">
          ...
          {errorMessage && (
            <div className="flex items-center gap-3 p-4 bg-red-50 border-2 border-red-200 rounded-xl text-red-700 animate-fade-in">
              <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full group relative overflow-hidden px-8 py-4 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 hover:from-amber-600 hover:via-orange-600 hover:to-amber-600 text-white  font-bold text-lg md:text-md rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
          >
