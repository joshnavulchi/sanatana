            ...
            <div className="relative z-10 p-6 md:p-8">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div className="flex-1">
                  <h3 className="text-md md:text-lg font-bold text-gray-900 mb-2 flex items-center gap-2">
                    <span className="md:hidden text-2xl">🍪</span>
                    Cookie Settings
                  </h3>
                  <div className="text-md md:text-lg md:text-xs md:text-base leading-relaxed">
                    {(() => {
              ...
              <div className="flex flex-col sm:flex-row items-center justify-end gap-3 mt-6">
                <button
                  className="
                      ...
                      text-gray-900
                      text-md md:text-lg md:text-xs md:text-base
                      rounded-full
