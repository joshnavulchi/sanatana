...
export default function CookieConsent() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-3 md:p-6 pointer-events-none text-md sm:text-base leading-relaxed font-normal">
        <div className="max-w-6xl mx-auto pointer-events-auto text-md sm:text-base leading-relaxed font-normal">
          <div className="relative bg-white/95 backdrop-blur-xl border-2 border-amber-200 rounded-2xl shadow-2xl overflow-hidden text-md sm:text-base leading-relaxed font-normal">
            {/* Decorative gradient overlay */}
            <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-orange-500/5 pointer-events-none text-md sm:text-base leading-relaxed font-normal" />

            {/* Top border accent */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-amber-400 via-orange-500 to-amber-400 text-md sm:text-base leading-relaxed font-normal" />

            {/* Content */}
            <div className="relative z-10 p-4 md:p-8 text-md sm:text-base leading-relaxed font-normal">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4 text-md sm:text-base leading-relaxed font-normal">
                ...
                <div className="flex-1 text-md sm:text-base leading-relaxed font-normal">
                  <h3 className="flex items-center gap-2 text-xl font-semibold leading-snug mb-2">
                    <span className="md:hidden text-md sm:text-base leading-relaxed font-normal">🍪</span>
                    Cookie Settings
                  </h3>
              ...
              {/* Buttons */}
              <div className="flex flex-col sm:flex-row items-center justify-end gap-3 text-md sm:text-base leading-relaxed font-normal">
                <button
                  className="px-4 py-2 bg-white border-2 border-amber-300 hover:border-amber-400 text-gray-900 text-md sm:text-base rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 no-underline whitespace-nowrap cursor-pointer"
                  onClick={() => setModalOpen(true)}
                >
                  <span className="flex items-center justify-center gap-2 text-md sm:text-base leading-relaxed font-normal">
                ...
                <button
                  className="px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white text-md sm:text-base rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 no-underline whitespace-nowrap cursor-pointer"
                  onClick={acceptAll}
                >
                  <span className="flex items-center justify-center gap-2 text-md sm:text-base leading-relaxed font-normal">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-tl from-amber-400/10 to-transparent rounded-tl-full pointer-events-none text-md sm:text-base leading-relaxed font-normal" />
          </div>
        </div>
      </div>
    </>
