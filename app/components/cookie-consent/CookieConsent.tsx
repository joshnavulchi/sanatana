    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-3 md:p-6 pointer-events-none">
        <div className="max-w-6xl mx-auto pointer-events-auto">
          <div className="relative bg-white/95 backdrop-blur-xl border-2 border-amber-200 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10 p-4 md:p-8">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                ...
                <div className="flex-shrink-0 hidden md:block">
                  <div className="w-16 h-16 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl flex items-center justify-center text-3xl shadow-lg animate-bounce">
                    🍪
                  </div>
                </div>
                ...
                <div className="flex-1">
                  <h3 className="text-xl md:text-base font-semibold text-gray-900 mb-2 flex items-center gap-2">
