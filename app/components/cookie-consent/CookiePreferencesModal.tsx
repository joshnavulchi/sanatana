        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="md:w-2/3 w-full">
            ...
            <div className="flex gap-2 mt-4 justify-end">
              <button className="cursor-pointer px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-amber-100 font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition" onClick={onClose}>Cancel</button>
              <button className="cursor-pointer px-4 py-2 rounded-lg bg-blue-500 text-white dark:text-amber-100 font-medium hover:bg-blue-600 transition" onClick={save}>Save preferences</button>
              <button className="cursor-pointer px-4 py-2 rounded-lg bg-green-500 text-white dark:text-amber-100 font-medium hover:bg-green-600 transition" onClick={acceptAll}>Accept all</button>
            </div>
          </div>
        </div>
      </div>
