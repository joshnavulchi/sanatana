      ...
      <div className={[
        ...
        <div className="relative flex items-center gap-3 px-6 py-6 md:px-8 md:py-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-lg md:text-md font-light text-white group-hover:text-white transition-colors duration-300 mt-3">{subtitle}</p>
          </div>
        </div>
      ...
      <div className="w-full md:mx-auto md:max-w-7xl relative z-10">
        ...
        <div className={`mb-16 md:mb-24 transition-all duration-1000 ease-out
          ...
          <div className="mx-auto max-w-5xl px-3">
            <p className="text-lg md:text-md leading-relaxed text-white">
              {subtitle}{' '}
              <Link
                href="/cosmictime"
        ...
        <div className={`mt-16 flex items-center justify-center gap-3 transition-all duration-1000 ease-out delay-700
          ...
          <span className="text-orange-300 text-lg md:text-md font-light">✦ CYCLE OF TIME ✦</span>
          <div className="h-px w-20 bg-gradient-to-l from-transparent to-orange-400" />
        </div>

        <div className="px-3 my-6">
          <h6 className="bg-white inline-flex text-lg md:text-md leading-relaxed shadow-md rounded-sm px-6 py-4 border-amber-50">
          ...
          <p className="text-lg md:text-md leading-relaxed my-3 text-white">
            {scalingComment}
          </p>
        </div>
