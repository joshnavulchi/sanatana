  ...
  return <div className="py-6 px-3">
    <div className={`
      ...
      <div className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-amber-700 via-orange-600 to-amber-700 bg-clip-text mb-2"> {page.essence_life} </h2>
      ...
      <div className="relative">
        ...
        <div className="relative bg-gradient-to-br from-amber-100/80 to-orange-100/80 rounded-2xl p-8 border-2 border-amber-300/30 backdrop-blur-sm">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl md:text-2xl  font-medium"> {page.know_thyself} </p>
