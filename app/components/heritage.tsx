  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-50 border-t border-orange-200">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p className="mt-8 text-md md:text-lg text-amber-900 leading-relaxed">
        ...
        <p className="mt-6 text-md md:text-lg text-amber-900 leading-relaxed">
        ...
        <p className="mt-6 text-md md:text-lg font-semibold text-orange-800">
      ...
      <ul className="mx-auto max-w-7xl text-md md:text-lg hidden">
        <li className="flex text-md md:text-lg text-amber-900 mb-2!">
