  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-50 border-t border-orange-200">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p className="mt-8 text-md text-amber-900 leading-relaxed">
        ...
        <p className="mt-6 text-md text-amber-900 leading-relaxed">
        ...
        <p className="mt-6 text-md font-semibold text-orange-800">
      ...
      <ul className="mx-auto max-w-7xl text-md hidden">
        <li className="flex text-md text-amber-900 mb-2!">
