  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-50 border-t border-orange-200">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p className="mt-8 text-base md:text-lg text-amber-900 leading-relaxed">
        ...
        <p className="mt-6 text-base md:text-lg text-amber-900 leading-relaxed">
        ...
        <p className="mt-6 text-base md:text-lg font-semibold text-orange-800">
      ...
      <ul className="mx-auto max-w-7xl text-lg block mb-12! list-disc!">
        <li className="flex item-center gap-4 text-base md:text-lg text-amber-900 mb-2!">
          <svg className="w-5 h-5 group-hover/btn:translate-x-1 transition-transform animate-pulse" fill="none" stroke="#000" viewBox="0 0 24 24">
