    ...
    <section className="gradient-background map-wrapper min-h-screen relative z-0 py-28 md:py-0 px-3 overflow-hidden">
      ...
      <div
        className={`
          relative z-10
          md:content-wrapper 
          md:absolute md:top-1/2 md:left-20 md:-translate-y-1/2
          p-3 md:px-0 md:py-0
      ...
      >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                ...
                className="group/btn relative px-8 py-4
                  bg-white/90 hover:bg-white text-gray-900 text-lg
        ...
        <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full">
          ...
          <div className="absolute bottom-0 right-0 w-3 h-3 bg-orange-400 rounded-full animate-pulse" />
          <div className="absolute top-1/3 right-1/4 w-2 h-2 bg-amber-300 rounded-full animate-bounce" />
        </div>
      </div>
    </section>
  )
