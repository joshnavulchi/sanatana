...
export default function HeroSection({
  ...
  return <div className="relative w-full min-h-[600px] px-3 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Desktop hero image */}
        <Image className="hidden md:block" src="/images/home/hero.png" alt="Sanātana Dharma hero background" fill sizes="100vw" priority quality={90} style={{
        objectFit: 'cover',
        backgroundPosition: 'top right'
      }} unoptimized />
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 shadow-2xl transform hover:scale-105 transition-transform duration-500">
                ...
                <div className="text-center space-y-6">
                  ...
                  <p className="text-amber-200 text-sm">{page.truth_alone}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`w-full transition-all text-center duration-1000 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="flex flex-col md:mx-auto md:max-w-3xl">
              ...
              <div className="w-full text-center flex flex-col md:flex-row md:justify-center gap-4 mt-6">
                <Link href={hero?.primarycta?.link ? `/${hero.primarycta.link}` : '/scriptures'} className="group relative md:inline-flex px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-600
                ...
                <Link href={hero?.secondarycta?.link ? `/${hero.secondarycta.link}` : '/sanatanadharma'} className="group md:inline-flex px-8 py-4 bg-white/10 backdrop-blur-md
