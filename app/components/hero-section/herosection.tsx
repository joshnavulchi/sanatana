        ...
        <div className="w-full flex flex-col md:flex-row items-center py-16 md:py-32 md:gap-12">
          ...
          <div className={`w-full transition-all text-center duration-1000 ease-out ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="flex flex-col md:mx-auto md:max-w-3xl">
              <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-tight drop-shadow-2xl [text-shadow:_2px_2px_8px_rgb(0_0_0_/_80%)] mt-6">
                {hero?.heading || 'Sanātana Dharma'}
              </h3>
              <h4 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-amber-300 leading-snug drop-shadow-lg [text-shadow:_1px_1px_4px_rgb(0_0_0_/_60%)]">
