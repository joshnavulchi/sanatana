                    ...
                    <article key={sectionKey} className={variant.card}>
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className={`text-md font-semibold ${variant.title} mb-2`}>{`Part ${sectionKey.replace('part', '')}: ${section?.dataset_metadata?.title || sectionKey.replace(/_/g, ' ')}`}</h3>
                ...
                return (
                  <article key={sectionKey} className="bg-white border-l-4 rounded-2xl p-4 shadow-sm hover:shadow-md transform hover:-translate-y-1 transition">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-md font-semibold text-orange-800 mb-2">{sectionKey.replace(/_/g, ' ')}</h3>
                        <div className="space-y-3 text-amber-900 text-xl md:text-lg">
