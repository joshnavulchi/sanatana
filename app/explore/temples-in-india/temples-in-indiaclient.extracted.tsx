...
export default function TemplesInIndiaClient() {
  ...
  return <PageLayout metaKey="temples_in_india" title={data.title} breadcrumbs={[{
    ...
    label: data.title
      ...
      return <div key={section.id || index} className="relative bg-white border-2 border-sky-100 rounded-2xl p-6 md:p-8 mt-12 transform-gpu transition-transform duration-300 hover:-translate-y-1 hover:scale-104 ring-1 ring-sky-100/30 bg-white/85 backdrop-blur-sm group overflow-hidden">
      ...
      {data.disclaimer && <div className="relative bg-gradient-to-br from-sky-50 to-indigo-50 border-l-4 border-indigo-400 rounded-lg p-6 md:p-8 mt-12 ring-1 ring-sky-100/30 bg-white/70 backdrop-blur-sm">
          <div className="flex items-start gap-4">
