...
export default function ExploreClient() {
  ...
  return (
    <PageLayout
      ...
      <p className="text-md text-stone-600 mb-6">{t("explore.subtitle") || "Discover topics, timelines and stories."}</p>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-md text-stone-700">{t(p.descKey) || t(p.key)}</p>
                </div>
              </div>
