        ...
        {data.rulers.map((ruler: Ruler, i: number) => (
          <div key={i} className="relative group">
            ...
            ">
              ...
              <div className="space-y-2 text-md md:text-md">
                {ruler.dynasty && (
                  <p className="">
                      ...
                      <div key={i} className="bg-white  border-l-4 border-amber-500 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        <div className="flex items-start gap-3 mb-4">
                          ...
                          <div className="flex-1">
                            <h4 className="text-md md:text-md font-bold text-gray-900  mb-1">{item.term}</h4>
                            <p className="text-md md:text-md text-amber-800  font-semibold">{item.fullForm}</p>
                          </div>
                        </div>
