...
export default function SlugClient({ slug }: { slug: string }) {
  ...
  const ns = useLocaleSection(`vedic_philosophy_${slug}`);
  ...
  if (isLoading) {
    return (
      <PageLayout metaKey={`vedic_philosophy_${slug}`} title="" breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Vedic Science', href: '/vedic-philosophy' }, { label: displayTitle }]} className="layout-md">
  ...
  return (
    <PageLayout metaKey={`vedic_philosophy_${slug}`} title={displayTitle} breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Vedic Science', href: '/vedic-philosophy' }, { label: displayTitle }]} className="layout-md">
      {description && (
