        ...
        <div id="constitution-content">
          ...
          <div className="relative px-4 md:px-10 py-14 md:py-20 bg-gradient-to-br from-blue-100 via-cyan-50 to-white rounded-3xl overflow-hidden shadow-2xl border-4 border-blue-200">
            ...
            <div className="relative z-10">
              ...
              <p className="text-base md:text-2xl font-semibold leading-relaxed text-blue-900 drop-shadow-sm max-w-3xl mx-auto">
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  {section.content && (
                    <div className="text-base leading-relaxed pl-20 text-blue-800/90">
                  ...
                  {section.details && (
                    <div className="text-base leading-relaxed pl-20 text-blue-900/90">
