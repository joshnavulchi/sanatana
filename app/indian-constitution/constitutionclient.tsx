            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  {section.content && (
                    <div className="text-xl md:text-lg md:text-md md:text-md leading-relaxed pl-20 text-blue-800/90">
                  ...
                  {section.details && (
                    <div className="text-xl md:text-lg md:text-md md:text-md leading-relaxed pl-20 text-blue-900/90">
