...
import { VEDAS_CHAPTER_PARAMS } from '@lib/generated/scriptureStaticParams';
...
export async function generateStaticParams(): Promise<ReadonlyArray<ChapterPageParams>> {
  return VEDAS_CHAPTER_PARAMS;
}
