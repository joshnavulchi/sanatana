...
import _20 from './easymantras.json';
import _21 from './festivalPractices.json';
import _22 from './footer.json';
import _23 from './ganeshstotras.json';
import _24 from './hanumanstotras.json';
import _25 from './home.json';
import _26 from './horoscope.json';
import _27 from './illustratedstories.json';
import _28 from './karmaPhilosophy.json';
import _29 from './karnaStory.json';
import _30 from './kidsZone.json';
import _31 from './krishnaStory.json';
import _32 from './lakshmiStory.json';
import _33 from './languageDropdown.json';
import _34 from './mahabharata.json';
import _35 from './mayaAvidyaPhilosophy.json';
import _36 from './meta.json';
import _37 from './mokshaPhilosophy.json';
import _38 from './mythologicalquizzes.json';
import _39 from './nav.json';
import _40 from './parashuramaStory.json';
import _41 from './parvathiStory.json';
import _42 from './philosophy.json';
import _43 from './policies.json';
import _44 from './practices.json';
import _45 from './privacy.json';
import _46 from './privacypolicy.json';
import _47 from './puranas.json';
import _48 from './puranicStory.json';
import _49 from './purusharthaPhilosophy.json';
import _50 from './questions.json';
import _51 from './quiz.json';
import _52 from './ramanamaharshiStory.json';
import _53 from './ramayana.json';
import _54 from './ritualsPractices.json';
import _55 from './samsaraPhilosophy.json';
import _56 from './sanatanadharmam.json';
import _57 from './sankshepaRamayana.json';
import _58 from './saraswathiStory.json';
import _59 from './scriptures.json';
import _60 from './scrollToTop.json';
import _61 from './shivaStory.json';
import _62 from './shivastotras.json';
...
import _69 from './upanishads.json';
import _70 from './vasistaStory.json';
import _71 from './vastuPractices.json';
import _72 from './vedas.json';
import _73 from './vedasPage1.json';
import _74 from './vishnuStory.json';
import _75 from './vishnustotras.json';
import _76 from './vishwamitraStory.json';
import _77 from './yogaPhilosophy.json';
