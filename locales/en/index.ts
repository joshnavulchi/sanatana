...
import _14 from './cosmictime.json';
import _15 from './cta.json';
import _16 from './dailypoojas_practices.json';
import _17 from './dailyprayers_stotras.json';
import _18 from './devi_stotras.json';
import _19 from './dharma_philosophy.json';
import _20 from './donate.json';
import _21 from './easymantras_kidszone.json';
import _22 from './festival_practices.json';
import _23 from './footer.json';
import _24 from './ganesh_stotras.json';
import _25 from './hanuman_stotras.json';
import _26 from './home.json';
import _27 from './horoscope.json';
import _28 from './illustrated_stories.json';
import _29 from './karma_philosophy.json';
import _30 from './karna_story.json';
import _31 from './kidszone.json';
import _32 from './krishna_story.json';
import _33 from './lakshmi_story.json';
import _34 from './languageDropdown.json';
import _35 from './mahabharata_scriptures.json';
import _36 from './mayaAvidya_philosophy.json';
...
import _56 from './sanatanadharma.json';
import _57 from './sankshepa_ramayana_scriptures.json';
...
import _63 from './site_title.json';
