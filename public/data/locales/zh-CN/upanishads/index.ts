// @ts-nocheck
// Auto-generated index for folder 'zh-CN\upanishads'
...
const base: any = {};
const merged = ([_d0, _d1, _d2, _d3, _d4, _d5, _d6, _d7, _d8, _d9, _d10, _d11, _d12] as any[]).reduce((acc: any, cur: any) => deepMerge(acc, cur || {}), base as any);
