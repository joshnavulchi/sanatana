// @ts-nocheck
// Auto-generated index for folder 'zh-CN\explore'
...
import _j16 from './sanskrit_concepts.json';
import _j17 from './scriptures.json';
import _j18 from './shakti_peethas.json';
import _j19 from './solar.json';
import _j20 from './stories.json';
import _j21 from './stotrasmantras.json';
import _j22 from './vedic_gods.json';
import _j23 from './world_transformation.json';
import _d0 from './bharat/index';
...
const base: any = {};
const merged = ([_j0, _j1, _j2, _j3, _j4, _j5, _j6, _j7, _j8, _j9, _j10, _j11, _j12, _j13, _j14, _j15, _j16, _j17, _j18, _j19, _j20, _j21, _j22, _j23, _d0, _d1, _d2, _d3, _d4, _d5] as any[]).reduce((acc: any, cur: any) => deepMerge(acc, cur || {}), base as any);
